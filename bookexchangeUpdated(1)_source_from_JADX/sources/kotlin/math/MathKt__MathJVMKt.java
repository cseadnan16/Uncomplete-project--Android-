...
class MathKt__MathJVMKt extends MathKt__MathHKt {
    ...
    /* renamed from: ln */
    private static final double m93ln(double x) {
        return Math.log(x);
    }
    ...
    /* renamed from: ln */
    private static final float m94ln(float x) {
