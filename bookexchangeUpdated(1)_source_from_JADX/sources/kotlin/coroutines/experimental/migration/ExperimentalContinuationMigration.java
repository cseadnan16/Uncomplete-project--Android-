...
final class ExperimentalContinuationMigration<T> implements Continuation<T> {
    ...
    public void resume(T value) {
        ...
        continuation2.resumeWith(Result.m111constructorimpl(value));
    }
    ...
    public void resumeWithException(Throwable exception) {
        ...
        kotlin.coroutines.Continuation<T> continuation2 = this.continuation;
        Result.Companion companion = Result.Companion;
        continuation2.resumeWith(Result.m111constructorimpl(ResultKt.createFailure(exception)));
    }
}
