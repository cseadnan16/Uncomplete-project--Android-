...
public abstract class CoroutineImpl extends Lambda<Object> implements Continuation<Object> {
    ...
    public CoroutineImpl(int arity, Continuation<Object> completion2) {
        super(arity);
        this.completion = completion2;
        this.label = completion2 != null ? 0 : -1;
    ...
    public void resume(Object value) {
        ...
        try {
            Object doResume = doResume(value, (Throwable) null);
    ...
    public void resumeWithException(Throwable exception) {
        ...
        try {
            Object doResume = doResume((Object) null, exception);
            if (doResume == IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
                return;
            }
            if (continuation != null) {
