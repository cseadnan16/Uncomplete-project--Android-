...
@Metadata(mo20368bv = {1, 0, 3}, mo20369d1 = {"\u0000\u0012\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\u001a*\u0010\u0000\u001a\b\u0012\u0004\u0012\u0002H\u00020\u0001\"\u0004\b\u0000\u0010\u00022\u0006\u0010\u0003\u001a\u00020\u00042\f\u0010\u0005\u001a\b\u0012\u0004\u0012\u0002H\u00020\u0001H\u0000\u001a \u0010\u0006\u001a\b\u0012\u0004\u0012\u0002H\u00020\u0001\"\u0004\b\u0000\u0010\u00022\f\u0010\u0005\u001a\b\u0012\u0004\u0012\u0002H\u00020\u0001¨\u0006\u0007"}, mo20370d2 = {"interceptContinuationIfNeeded", "Lkotlin/coroutines/experimental/Continuation;", "T", "context", "Lkotlin/coroutines/experimental/CoroutineContext;", "continuation", "normalizeContinuation", "kotlin-stdlib-coroutines"}, mo20371k = 2, mo20372mv = {1, 1, 15})
...
public final class CoroutineIntrinsics {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:2:0x0016, code lost:
        r0 = r0.interceptContinuation(r2);
     */
    ...
    public static final <T> kotlin.coroutines.experimental.Continuation<T> interceptContinuationIfNeeded(kotlin.coroutines.experimental.CoroutineContext r1, kotlin.coroutines.experimental.Continuation<? super T> r2) {
        /*
            ...
            kotlin.coroutines.experimental.CoroutineContext$Element r0 = r1.get(r0)
            kotlin.coroutines.experimental.ContinuationInterceptor r0 = (kotlin.coroutines.experimental.ContinuationInterceptor) r0
            if (r0 == 0) goto L_0x001d
            kotlin.coroutines.experimental.Continuation r0 = r0.interceptContinuation(r2)
            if (r0 == 0) goto L_0x001d
            goto L_0x001e
        L_0x001d:
            r0 = r2
