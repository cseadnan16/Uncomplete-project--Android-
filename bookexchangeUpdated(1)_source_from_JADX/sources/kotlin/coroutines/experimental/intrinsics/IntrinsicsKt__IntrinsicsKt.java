...
class IntrinsicsKt__IntrinsicsKt extends IntrinsicsKt__IntrinsicsJvmKt {
    ...
    private static final <T> Continuation<T> intercepted(Continuation<? super T> $this$intercepted) {
