...
class IntrinsicsKt__IntrinsicsJvmKt {
    ...
    public static final <T> Continuation<Unit> createCoroutineUnchecked(Function1<? super Continuation<? super T>, ? extends Object> $this$createCoroutineUnchecked, Continuation<? super T> completion) {
        ...
        if (!($this$createCoroutineUnchecked instanceof CoroutineImpl)) {
            return CoroutineIntrinsics.interceptContinuationIfNeeded(completion.getContext(), new C0971x6df69f96(completion, $this$createCoroutineUnchecked, completion));
        }
        Continuation<Unit> create = ((CoroutineImpl) $this$createCoroutineUnchecked).create(completion);
        if (create != null) {
    ...
    public static final <R, T> Continuation<Unit> createCoroutineUnchecked(Function2<? super R, ? super Continuation<? super T>, ? extends Object> $this$createCoroutineUnchecked, R receiver, Continuation<? super T> completion) {
        ...
        Intrinsics.checkParameterIsNotNull(completion, "completion");
        if (!($this$createCoroutineUnchecked instanceof CoroutineImpl)) {
            return CoroutineIntrinsics.interceptContinuationIfNeeded(completion.getContext(), new C0972x6df69f97(completion, $this$createCoroutineUnchecked, receiver, completion));
        }
        Continuation<Unit> create = ((CoroutineImpl) $this$createCoroutineUnchecked).create(receiver, completion);
        if (create != null) {
            return ((CoroutineImpl) create).getFacade();
        }
        throw new TypeCastException("null cannot be cast to non-null type kotlin.coroutines.experimental.jvm.internal.CoroutineImpl");
    ...
    private static final <T> Continuation<Unit> buildContinuationByInvokeCall$IntrinsicsKt__IntrinsicsJvmKt(Continuation<? super T> completion, Function0<? extends Object> block) {
        return CoroutineIntrinsics.interceptContinuationIfNeeded(completion.getContext(), new C0973x502cf9f5(completion, block));
    }
