        ...
        while (true) {
            ...
            try {
                ...
                if (outcome != IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
                    ...
                    obj = Result.m111constructorimpl(outcome);
                    Object outcome2 = obj;
                ...
                obj = Result.m111constructorimpl(ResultKt.createFailure(exception));
            }
        }
    }
