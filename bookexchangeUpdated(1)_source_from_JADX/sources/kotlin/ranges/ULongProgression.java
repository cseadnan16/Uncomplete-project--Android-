...
public class ULongProgression implements Iterable<ULong>, KMappedMarker {
    ...
    private ULongProgression(long start, long endInclusive, long step2) {
        if (step2 == 0) {
            ...
            this.first = start;
            this.last = UProgressionUtilKt.m972getProgressionLastElement7ftBX0g(start, endInclusive, step2);
            this.step = step2;
        } else {
    ...
    public int hashCode() {
        ...
        long j2 = this.last;
        long j3 = this.step;
        return ((int) (j3 ^ (j3 >>> 32))) + (((((int) ULong.m265constructorimpl(j ^ ULong.m265constructorimpl(j >>> 32))) * 31) + ((int) ULong.m265constructorimpl(j2 ^ ULong.m265constructorimpl(j2 >>> 32)))) * 31);
    }
    ...
    public String toString() {
        ...
        long j;
        if (this.step > 0) {
            sb.append(ULong.m302toStringimpl(this.first));
            sb.append("..");
            sb.append(ULong.m302toStringimpl(this.last));
            sb.append(" step ");
            j = this.step;
        } else {
    ...
    @Metadata(mo20368bv = {1, 0, 3}, mo20369d1 = {"\u0000\"\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\t\n\u0002\b\u0003\b\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J(\u0010\u0003\u001a\u00020\u00042\u0006\u0010\u0005\u001a\u00020\u00062\u0006\u0010\u0007\u001a\u00020\u00062\u0006\u0010\b\u001a\u00020\tø\u0001\u0000¢\u0006\u0004\b\n\u0010\u000b\u0002\u0004\n\u0002\b\u0019¨\u0006\f"}, mo20370d2 = {"Lkotlin/ranges/ULongProgression$Companion;", "", "()V", "fromClosedRange", "Lkotlin/ranges/ULongProgression;", "rangeStart", "Lkotlin/ULong;", "rangeEnd", "step", "", "fromClosedRange-7ftBX0g", "(JJJ)Lkotlin/ranges/ULongProgression;", "kotlin-stdlib"}, mo20371k = 1, mo20372mv = {1, 1, 15})
    /* compiled from: ULongRange.kt */
    public static final class Companion {
        ...
        public final ULongProgression m989fromClosedRange7ftBX0g(long rangeStart, long rangeEnd, long step) {
