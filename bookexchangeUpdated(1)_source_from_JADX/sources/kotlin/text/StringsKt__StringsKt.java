...
class StringsKt__StringsKt extends StringsKt__StringsJVMKt {
    ...
    public static final Pair<Integer, String> findAnyOf$StringsKt__StringsKt(CharSequence $this$findAnyOf, Collection<String> strings, int startIndex, boolean ignoreCase, boolean last) {
                ...
                if (step < 0 ? first >= last2 : first <= last2) {
                    while (true) {
                        ...
                        if (matchingString == null) {
                            ...
                            return TuplesKt.m82to(Integer.valueOf(index), matchingString);
                        }
                    }
                }
            } else {
                ...
                if (step2 < 0 ? index2 >= last3 : index2 <= last3) {
                    while (true) {
                        ...
                        if (matchingString2 == null) {
                            ...
                            return TuplesKt.m82to(Integer.valueOf(index3), matchingString2);
                        }
                    }
                }
            }
        ...
        String str = string;
        int i2 = startIndex;
        int index4 = !last ? StringsKt.indexOf$default(charSequence2, str, i2, false, 4, (Object) null) : StringsKt.lastIndexOf$default(charSequence2, str, i2, false, 4, (Object) null);
        if (index4 < 0) {
            return null;
        }
        return TuplesKt.m82to(Integer.valueOf(index4), string);
    }
