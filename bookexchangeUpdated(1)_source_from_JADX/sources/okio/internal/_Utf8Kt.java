...
@Metadata(mo20368bv = {1, 0, 3}, mo20369d1 = {"\u0000\u0016\n\u0000\n\u0002\u0010\u0012\n\u0002\u0010\u000e\n\u0002\b\u0002\n\u0002\u0010\b\n\u0002\b\u0002\u001a\n\u0010\u0000\u001a\u00020\u0001*\u00020\u0002\u001a\u001e\u0010\u0003\u001a\u00020\u0002*\u00020\u00012\b\b\u0002\u0010\u0004\u001a\u00020\u00052\b\b\u0002\u0010\u0006\u001a\u00020\u0005¨\u0006\u0007"}, mo20370d2 = {"commonAsUtf8ToByteArray", "", "", "commonToUtf8String", "beginIndex", "", "endIndex", "okio"}, mo20371k = 2, mo20372mv = {1, 1, 15})
                                ...
                                if (!((b3$iv$iv & 192) == 128)) {
                                    ...
                                    if (codePoint$iv$iv3 > 1114111) {
                                        ...
                                        if (codePoint$iv != 65533) {
                                            ...
                                            length2 = length19 + 1;
                                            chars[length19] = (char) ((codePoint$iv & 1023) + Utf8.LOG_SURROGATE_HEADER);
                                            i = 4;
                                            length = length2;
                                        } else {
                                            length3 = length11 + 1;
        ...
        for (int index = 0; index < length; index++) {
            ...
            if (b0 >= 128) {
                ...
                while (index$iv2 < endIndex$iv) {
                    char c$iv = $this$processUtf8Bytes$iv.charAt(index$iv2);
                    if (c$iv < 128) {
                        int size = index$iv + 1;
                        bytes[index$iv] = (byte) c$iv;
                        index$iv2++;
                        while (index$iv2 < endIndex$iv && $this$processUtf8Bytes$iv.charAt(index$iv2) < 128) {
                        ...
                        index$iv2++;
                        index$iv = size4 + 1;
                    } else if (c$iv > 56319 || endIndex$iv <= index$iv2 + 1 || 56320 > (charAt = $this$processUtf8Bytes$iv.charAt(index$iv2 + 1)) || 57343 < charAt) {
