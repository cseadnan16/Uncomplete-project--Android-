...
public final class RealBufferedSink implements BufferedSink {
    ...
    public long writeAll(Source source) {
        ...
        while (true) {
            long readCount$iv = source.read(this.bufferField, (long) 8192);
            if (readCount$iv == -1) {
