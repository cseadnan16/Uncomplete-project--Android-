...
abstract class ParameterHandler<T> {
    ...
    static final class RelativeUrl extends ParameterHandler<Object> {
        ...
        public void apply(RequestBuilder builder, @Nullable Object value) {
            C1244Utils.checkNotNull(value, "@Url parameter is null.");
    ...
    static final class Header<T> extends ParameterHandler<T> {
        ...
        Header(String name2, Converter<T, String> valueConverter2) {
            this.name = (String) C1244Utils.checkNotNull(name2, "name == null");
            ...
            if (value != null) {
                for (Map.Entry<String, T> entry : value.entrySet()) {
                    ...
                    if (entryKey != null) {
                        T entryValue = entry.getValue();
                        if (entryValue != null) {
                            builder.addPart(Headers.m96of("Content-Disposition", "form-data; name=\"" + entryKey + "\"", "Content-Transfer-Encoding", this.transferEncoding), this.valueConverter.convert(entryValue));
                        } else {
