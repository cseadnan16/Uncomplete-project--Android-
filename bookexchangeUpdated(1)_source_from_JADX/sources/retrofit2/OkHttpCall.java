...
final class OkHttpCall<T> implements Call<T> {
    ...
    OkHttpCall(RequestFactory requestFactory2, Object[] args2, Call.Factory callFactory2, Converter<ResponseBody, T> responseConverter2) {
    ...
    public void enqueue(final Callback<T> callback) {
        Call call;
        Throwable failure;
        C1244Utils.checkNotNull(callback, "callback == null");
        synchronized (this) {
            if (!this.executed) {
                this.executed = true;
                call = this.rawCall;
    ...
    public Response<T> parseResponse(Response rawResponse) throws IOException {
        ...
        if (code < 200 || code >= 300) {
            try {
                return Response.error(C1244Utils.buffer(rawBody), rawResponse2);
            } finally {
                rawBody.close();
            }
