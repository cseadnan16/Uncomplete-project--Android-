...
/* renamed from: retrofit2.Utils */
final class C1244Utils {
    ...
    static RuntimeException methodError(Method method, String message, Object... args) {
        return methodError(method, (Throwable) null, message, args);
    }
    ...
    static java.lang.reflect.Type resolve(java.lang.reflect.Type r9, java.lang.Class<?> r10, java.lang.reflect.Type r11) {
        ...
        L_0x00d7:
            ...
            throw r9
        */
        throw new UnsupportedOperationException("Method not decompiled: retrofit2.C1244Utils.resolve(java.lang.reflect.Type, java.lang.Class, java.lang.reflect.Type):java.lang.reflect.Type");
    }
    ...
    /* renamed from: retrofit2.Utils$ParameterizedTypeImpl */
    private static final class ParameterizedTypeImpl implements ParameterizedType {
        ...
        ParameterizedTypeImpl(@Nullable Type ownerType2, Type rawType2, Type... typeArguments2) {
            ...
            for (Type typeArgument : typeArguments2) {
                C1244Utils.checkNotNull(typeArgument, "typeArgument == null");
                C1244Utils.checkNotPrimitive(typeArgument);
            }
        ...
        public boolean equals(Object other) {
            return (other instanceof ParameterizedType) && C1244Utils.equals(this, (ParameterizedType) other);
        }
        ...
        public String toString() {
            if (this.typeArguments.length == 0) {
                return C1244Utils.typeToString(this.rawType);
            }
            StringBuilder result = new StringBuilder((this.typeArguments.length + 1) * 30);
            result.append(C1244Utils.typeToString(this.rawType));
            result.append("<");
            result.append(C1244Utils.typeToString(this.typeArguments[0]));
            for (int i = 1; i < this.typeArguments.length; i++) {
                result.append(", ");
                result.append(C1244Utils.typeToString(this.typeArguments[i]));
            }
            result.append(">");
    ...
    /* renamed from: retrofit2.Utils$GenericArrayTypeImpl */
    private static final class GenericArrayTypeImpl implements GenericArrayType {
        ...
        public boolean equals(Object o) {
            return (o instanceof GenericArrayType) && C1244Utils.equals(this, (GenericArrayType) o);
        }
        ...
        public String toString() {
            return C1244Utils.typeToString(this.componentType) + HttpUrl.PATH_SEGMENT_ENCODE_SET_URI;
        }
    }

    /* renamed from: retrofit2.Utils$WildcardTypeImpl */
    private static final class WildcardTypeImpl implements WildcardType {
        ...
        WildcardTypeImpl(Type[] upperBounds, Type[] lowerBounds) {
            if (lowerBounds.length > 1) {
                ...
                if (lowerBounds[0] != null) {
                    C1244Utils.checkNotPrimitive(lowerBounds[0]);
                ...
                C1244Utils.checkNotPrimitive(upperBounds[0]);
        ...
        public Type[] getLowerBounds() {
            ...
            if (type == null) {
                return C1244Utils.EMPTY_TYPE_ARRAY;
            }
            return new Type[]{type};
        }

        public boolean equals(Object other) {
            return (other instanceof WildcardType) && C1244Utils.equals(this, (WildcardType) other);
        }
        ...
        public String toString() {
            if (this.lowerBound != null) {
                return "? super " + C1244Utils.typeToString(this.lowerBound);
            } else if (this.upperBound == Object.class) {
                return "?";
            } else {
                return "? extends " + C1244Utils.typeToString(this.upperBound);
            }
        }
    }
