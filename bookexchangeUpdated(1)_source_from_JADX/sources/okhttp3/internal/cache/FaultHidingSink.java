...
public class FaultHidingSink extends ForwardingSink {
    ...
    public FaultHidingSink(Sink delegate, Function1<? super IOException, Unit> onException2) {
        super(delegate);
        Intrinsics.checkParameterIsNotNull(delegate, "delegate");
        Intrinsics.checkParameterIsNotNull(onException2, "onException");
        this.onException = onException2;
    }
