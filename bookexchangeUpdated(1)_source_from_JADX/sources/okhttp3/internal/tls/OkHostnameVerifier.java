...
@Metadata(mo20368bv = {1, 0, 3}, mo20369d1 = {"\u00006\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\b\n\u0002\b\u0002\n\u0002\u0010 \n\u0002\u0010\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010\u000b\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0006\bÆ\u0002\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u0014\u0010\u0006\u001a\b\u0012\u0004\u0012\u00020\b0\u00072\u0006\u0010\t\u001a\u00020\nJ\u001e\u0010\u000b\u001a\b\u0012\u0004\u0012\u00020\b0\u00072\u0006\u0010\t\u001a\u00020\n2\u0006\u0010\f\u001a\u00020\u0004H\u0002J\u0016\u0010\r\u001a\u00020\u000e2\u0006\u0010\u000f\u001a\u00020\b2\u0006\u0010\t\u001a\u00020\nJ\u0018\u0010\r\u001a\u00020\u000e2\u0006\u0010\u000f\u001a\u00020\b2\u0006\u0010\u0010\u001a\u00020\u0011H\u0016J\u0018\u0010\u0012\u001a\u00020\u000e2\u0006\u0010\u0013\u001a\u00020\b2\u0006\u0010\t\u001a\u00020\nH\u0002J\u001c\u0010\u0012\u001a\u00020\u000e2\b\u0010\u0013\u001a\u0004\u0018\u00010\b2\b\u0010\u0014\u001a\u0004\u0018\u00010\bH\u0002J\u0018\u0010\u0015\u001a\u00020\u000e2\u0006\u0010\u0016\u001a\u00020\b2\u0006\u0010\t\u001a\u00020\nH\u0002R\u000e\u0010\u0003\u001a\u00020\u0004XT¢\u0006\u0002\n\u0000R\u000e\u0010\u0005\u001a\u00020\u0004XT¢\u0006\u0002\n\u0000¨\u0006\u0017"}, mo20370d2 = {"Lokhttp3/internal/tls/OkHostnameVerifier;", "Ljavax/net/ssl/HostnameVerifier;", "()V", "ALT_DNS_NAME", "", "ALT_IPA_NAME", "allSubjectAltNames", "", "", "certificate", "Ljava/security/cert/X509Certificate;", "getSubjectAltNames", "type", "verify", "", "host", "session", "Ljavax/net/ssl/SSLSession;", "verifyHostname", "hostname", "pattern", "verifyIpAddress", "ipAddress", "okhttp"}, mo20371k = 1, mo20372mv = {1, 1, 16})
...
public final class OkHostnameVerifier implements HostnameVerifier {
    ...
    private final boolean verifyHostname(String hostname, String pattern) {
        ...
        if ((charSequence == null || charSequence.length() == 0) || StringsKt.startsWith$default(hostname2, ".", false, 2, (Object) null) || StringsKt.endsWith$default(hostname2, "..", false, 2, (Object) null)) {
            return false;
        }
        CharSequence charSequence2 = pattern2;
        if ((charSequence2 == null || charSequence2.length() == 0) || StringsKt.startsWith$default(pattern2, ".", false, 2, (Object) null) || StringsKt.endsWith$default(pattern2, "..", false, 2, (Object) null)) {
            return false;
        }
        ...
        if (pattern2 != null) {
            ...
            if (!StringsKt.contains$default((CharSequence) pattern3, (CharSequence) "*", false, 2, (Object) null)) {
                return Intrinsics.areEqual((Object) hostname2, (Object) pattern3);
            }
            if (!StringsKt.startsWith$default(pattern3, "*.", false, 2, (Object) null) || StringsKt.indexOf$default((CharSequence) pattern3, '*', 1, false, 4, (Object) null) != -1 || hostname2.length() < pattern3.length() || Intrinsics.areEqual((Object) "*.", (Object) pattern3)) {
                return false;
            }
            if (pattern3 != null) {
            ...
            for (List subjectAltName : subjectAltNames) {
                if (subjectAltName != null) {
                    if (subjectAltName.size() >= 2) {
                        if (!(!Intrinsics.areEqual(subjectAltName.get(0), (Object) Integer.valueOf(type)))) {
