...
public final class Http2Connection$writeSynResetLater$$inlined$execute$1 extends Task {
    ...
    public Http2Connection$writeSynResetLater$$inlined$execute$1(String $captured_local_variable$1, boolean $captured_local_variable$2, String $super_call_param$3, boolean $super_call_param$4, Http2Connection http2Connection, int i, ErrorCode errorCode) {
