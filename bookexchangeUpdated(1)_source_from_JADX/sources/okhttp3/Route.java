...
public final class Route {
    ...
    public Route(Address address2, Proxy proxy2, InetSocketAddress socketAddress2) {
        Intrinsics.checkParameterIsNotNull(address2, "address");
        Intrinsics.checkParameterIsNotNull(proxy2, "proxy");
        Intrinsics.checkParameterIsNotNull(socketAddress2, "socketAddress");
    ...
    public final Address m1216deprecated_address() {
        return this.address;
    }
    ...
    public int hashCode() {
        return (((((17 * 31) + this.address.hashCode()) * 31) + this.proxy.hashCode()) * 31) + this.socketAddress.hashCode();
    }
