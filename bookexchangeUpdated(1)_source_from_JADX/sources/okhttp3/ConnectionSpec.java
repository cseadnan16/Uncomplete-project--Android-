...
public final class ConnectionSpec {
    ...
    public final List<CipherSuite> cipherSuites() {
        ...
        for (String it : strArr) {
            destination$iv$iv.add(CipherSuite.Companion.forJavaName(it));
        }
    ...
    public final List<CipherSuite> m1113deprecated_cipherSuites() {
        return cipherSuites();
    }
    ...
    public final List<TlsVersion> tlsVersions() {
        ...
        Collection destination$iv$iv = new ArrayList(strArr.length);
        for (String it : strArr) {
            destination$iv$iv.add(TlsVersion.Companion.forJavaName(it));
        }
        return CollectionsKt.toList((List) destination$iv$iv);
    }
    ...
    public final List<TlsVersion> m1115deprecated_tlsVersions() {
        return tlsVersions();
    }
    ...
    public final boolean m1114deprecated_supportsTlsExtensions() {
        return this.supportsTlsExtensions;
    }
    ...
    public boolean equals(Object other) {
        ...
        if (!z || (Arrays.equals(this.cipherSuitesAsString, ((ConnectionSpec) other).cipherSuitesAsString) && Arrays.equals(this.tlsVersionsAsString, ((ConnectionSpec) other).tlsVersionsAsString) && this.supportsTlsExtensions == ((ConnectionSpec) other).supportsTlsExtensions)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        String[] strArr = this.cipherSuitesAsString;
        int i2 = 0;
        int result = (i + (strArr != null ? Arrays.hashCode(strArr) : 0)) * 31;
        String[] strArr2 = this.tlsVersionsAsString;
        if (strArr2 != null) {
            i2 = Arrays.hashCode(strArr2);
        }
        return ((result + i2) * 31) + (this.supportsTlsExtensions ^ true ? 1 : 0);
    }
    ...
    @Metadata(mo20368bv = {1, 0, 3}, mo20369d1 = {"\u00004\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\u000b\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0011\n\u0002\u0010\u000e\n\u0002\b\u0012\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\u0018\u00002\u00020\u0001B\u000f\b\u0010\u0012\u0006\u0010\u0002\u001a\u00020\u0003¢\u0006\u0002\u0010\u0004B\u000f\b\u0016\u0012\u0006\u0010\u0005\u001a\u00020\u0006¢\u0006\u0002\u0010\u0007J\u0006\u0010\u0019\u001a\u00020\u0000J\u0006\u0010\u001a\u001a\u00020\u0000J\u0006\u0010\u001b\u001a\u00020\u0006J\u001f\u0010\b\u001a\u00020\u00002\u0012\u0010\b\u001a\n\u0012\u0006\b\u0001\u0012\u00020\n0\t\"\u00020\n¢\u0006\u0002\u0010\u001cJ\u001f\u0010\b\u001a\u00020\u00002\u0012\u0010\b\u001a\n\u0012\u0006\b\u0001\u0012\u00020\u001d0\t\"\u00020\u001d¢\u0006\u0002\u0010\u001eJ\u0010\u0010\u0010\u001a\u00020\u00002\u0006\u0010\u0010\u001a\u00020\u0003H\u0007J\u001f\u0010\u0016\u001a\u00020\u00002\u0012\u0010\u0016\u001a\n\u0012\u0006\b\u0001\u0012\u00020\n0\t\"\u00020\n¢\u0006\u0002\u0010\u001cJ\u001f\u0010\u0016\u001a\u00020\u00002\u0012\u0010\u0016\u001a\n\u0012\u0006\b\u0001\u0012\u00020\u001f0\t\"\u00020\u001f¢\u0006\u0002\u0010 R$\u0010\b\u001a\n\u0012\u0004\u0012\u00020\n\u0018\u00010\tX\u000e¢\u0006\u0010\n\u0002\u0010\u000f\u001a\u0004\b\u000b\u0010\f\"\u0004\b\r\u0010\u000eR\u001a\u0010\u0010\u001a\u00020\u0003X\u000e¢\u0006\u000e\n\u0000\u001a\u0004\b\u0011\u0010\u0012\"\u0004\b\u0013\u0010\u0004R\u001a\u0010\u0002\u001a\u00020\u0003X\u000e¢\u0006\u000e\n\u0000\u001a\u0004\b\u0014\u0010\u0012\"\u0004\b\u0015\u0010\u0004R$\u0010\u0016\u001a\n\u0012\u0004\u0012\u00020\n\u0018\u00010\tX\u000e¢\u0006\u0010\n\u0002\u0010\u000f\u001a\u0004\b\u0017\u0010\f\"\u0004\b\u0018\u0010\u000e¨\u0006!"}, mo20370d2 = {"Lokhttp3/ConnectionSpec$Builder;", "", "tls", "", "(Z)V", "connectionSpec", "Lokhttp3/ConnectionSpec;", "(Lokhttp3/ConnectionSpec;)V", "cipherSuites", "", "", "getCipherSuites$okhttp", "()[Ljava/lang/String;", "setCipherSuites$okhttp", "([Ljava/lang/String;)V", "[Ljava/lang/String;", "supportsTlsExtensions", "getSupportsTlsExtensions$okhttp", "()Z", "setSupportsTlsExtensions$okhttp", "getTls$okhttp", "setTls$okhttp", "tlsVersions", "getTlsVersions$okhttp", "setTlsVersions$okhttp", "allEnabledCipherSuites", "allEnabledTlsVersions", "build", "([Ljava/lang/String;)Lokhttp3/ConnectionSpec$Builder;", "Lokhttp3/CipherSuite;", "([Lokhttp3/CipherSuite;)Lokhttp3/ConnectionSpec$Builder;", "Lokhttp3/TlsVersion;", "([Lokhttp3/TlsVersion;)Lokhttp3/ConnectionSpec$Builder;", "okhttp"}, mo20371k = 1, mo20372mv = {1, 1, 16})
    /* compiled from: ConnectionSpec.kt */
    public static final class Builder {
        ...
        public final Builder cipherSuites(CipherSuite... cipherSuites2) {
            Intrinsics.checkParameterIsNotNull(cipherSuites2, "cipherSuites");
            Builder $this$apply = this;
            if ($this$apply.tls) {
                CipherSuite[] cipherSuiteArr = cipherSuites2;
                Collection destination$iv$iv = new ArrayList(cipherSuiteArr.length);
                for (CipherSuite it : cipherSuiteArr) {
                    destination$iv$iv.add(it.javaName());
                }
        ...
        public final Builder tlsVersions(TlsVersion... tlsVersions2) {
            Intrinsics.checkParameterIsNotNull(tlsVersions2, "tlsVersions");
            Builder $this$apply = this;
            if ($this$apply.tls) {
                TlsVersion[] tlsVersionArr = tlsVersions2;
                Collection destination$iv$iv = new ArrayList(tlsVersionArr.length);
                for (TlsVersion it : tlsVersionArr) {
                    destination$iv$iv.add(it.javaName());
                }
                Object[] array = ((List) destination$iv$iv).toArray(new String[0]);
                if (array != null) {
        ...
        public final Builder supportsTlsExtensions(boolean supportsTlsExtensions2) {
            Builder $this$apply = this;
            if ($this$apply.tls) {
                $this$apply.supportsTlsExtensions = supportsTlsExtensions2;
                return this;
            }
    ...
    @Metadata(mo20368bv = {1, 0, 3}, mo20369d1 = {"\u0000 \n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u0011\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0005\b\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u0016\u0010\u0003\u001a\b\u0012\u0004\u0012\u00020\u00050\u0004X\u0004¢\u0006\u0004\n\u0002\u0010\u0006R\u0010\u0010\u0007\u001a\u00020\b8\u0006X\u0004¢\u0006\u0002\n\u0000R\u0010\u0010\t\u001a\u00020\b8\u0006X\u0004¢\u0006\u0002\n\u0000R\u0010\u0010\n\u001a\u00020\b8\u0006X\u0004¢\u0006\u0002\n\u0000R\u0016\u0010\u000b\u001a\b\u0012\u0004\u0012\u00020\u00050\u0004X\u0004¢\u0006\u0004\n\u0002\u0010\u0006R\u0010\u0010\f\u001a\u00020\b8\u0006X\u0004¢\u0006\u0002\n\u0000¨\u0006\r"}, mo20370d2 = {"Lokhttp3/ConnectionSpec$Companion;", "", "()V", "APPROVED_CIPHER_SUITES", "", "Lokhttp3/CipherSuite;", "[Lokhttp3/CipherSuite;", "CLEARTEXT", "Lokhttp3/ConnectionSpec;", "COMPATIBLE_TLS", "MODERN_TLS", "RESTRICTED_CIPHER_SUITES", "RESTRICTED_TLS", "okhttp"}, mo20371k = 1, mo20372mv = {1, 1, 16})
    /* compiled from: ConnectionSpec.kt */
