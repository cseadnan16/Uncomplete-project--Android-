...
abstract class DateFormatTextWatcher implements TextWatcher {
    ...
    DateFormatTextWatcher(String formatHint2, DateFormat dateFormat2, TextInputLayout textInputLayout2, CalendarConstraints constraints2) {
        ...
        this.outOfRange = textInputLayout2.getContext().getString(C1130R.string.mtrl_picker_out_of_range);
    }
    ...
    public void onTextChanged(CharSequence s, int start, int before, int count) {
        ...
        try {
            ...
            String invalidFormat = this.textInputLayout.getContext().getString(C1130R.string.mtrl_picker_invalid_format);
            String useLine = String.format(this.textInputLayout.getContext().getString(C1130R.string.mtrl_picker_invalid_format_use), new Object[]{this.formatHint});
            String exampleLine = String.format(this.textInputLayout.getContext().getString(C1130R.string.mtrl_picker_invalid_format_example), new Object[]{this.dateFormat.format(new Date(UtcDates.getTodayCalendar().getTimeInMillis()))});
