...
public class RangeDateSelector implements DateSelector<Pair<Long, Long>> {
    ...
    public int getDefaultThemeResId(Context context) {
        ...
        return MaterialAttributes.resolveOrThrow(context, Math.min(display.widthPixels, display.heightPixels) > res.getDimensionPixelSize(C1130R.dimen.mtrl_calendar_maximum_default_fullscreen_minor_axis) ? C1130R.attr.materialCalendarTheme : C1130R.attr.materialCalendarFullscreenTheme, MaterialDatePicker.class.getCanonicalName());
    }

    public String getSelectionDisplayString(Context context) {
        Resources res = context.getResources();
        if (this.selectedStartItem == null && this.selectedEndItem == null) {
            return res.getString(C1130R.string.mtrl_picker_range_header_unselected);
        }
        Long l = this.selectedEndItem;
        if (l == null) {
            return res.getString(C1130R.string.mtrl_picker_range_header_only_start_selected, new Object[]{DateStrings.getDateString(this.selectedStartItem.longValue())});
        }
        Long l2 = this.selectedStartItem;
        if (l2 == null) {
            return res.getString(C1130R.string.mtrl_picker_range_header_only_end_selected, new Object[]{DateStrings.getDateString(this.selectedEndItem.longValue())});
        }
        Pair<String, String> dateRangeStrings = DateStrings.getDateRangeString(l2, l);
        return res.getString(C1130R.string.mtrl_picker_range_header_selected, new Object[]{dateRangeStrings.first, dateRangeStrings.second});
    }

    public int getDefaultTitleResId() {
        return C1130R.string.mtrl_picker_range_header_title;
    }
    ...
    public View onCreateTextInputView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle, CalendarConstraints constraints, OnSelectionChangedListener<Pair<Long, Long>> listener) {
        View root = layoutInflater.inflate(C1130R.layout.mtrl_picker_text_input_date_range, viewGroup, false);
        TextInputLayout startTextInput = (TextInputLayout) root.findViewById(C1130R.C1133id.mtrl_picker_text_input_range_start);
        TextInputLayout endTextInput = (TextInputLayout) root.findViewById(C1130R.C1133id.mtrl_picker_text_input_range_end);
        ...
        this.invalidRangeStartError = root.getResources().getString(C1130R.string.mtrl_picker_invalid_range);
        ...
        C05681 r0 = new DateFormatTextWatcher(textInputHint, format, startTextInput, calendarConstraints) {
