...
public final class TabLayoutMediator {
    private RecyclerView.C0354Adapter<?> adapter;
    ...
    public void attach() {
        if (!this.attached) {
            RecyclerView.C0354Adapter<?> adapter2 = this.viewPager.getAdapter();
    ...
    public void detach() {
        RecyclerView.C0354Adapter<?> adapter2;
    ...
    public void populateTabsFromPagerAdapter() {
        ...
        RecyclerView.C0354Adapter<?> adapter2 = this.adapter;
        if (adapter2 != null) {
