...
abstract class MaterialTransitionSet<T extends Transition> extends TransitionSet {
    ...
    public void setSecondaryTransition(Transition secondaryTransition2) {
        TransitionUtils.maybeRemoveTransition(this, this.secondaryTransition);
        this.secondaryTransition = secondaryTransition2;
        TransitionUtils.maybeAddTransition(this, secondaryTransition2);
    }
}
