...
public class MaterialCardView extends CardView implements Checkable, Shapeable {
    ...
    private static final int DEF_STYLE_RES = C1130R.style.Widget_MaterialComponents_CardView;
    private static final int[] DRAGGED_STATE_SET = {C1130R.attr.state_dragged};
    ...
    public MaterialCardView(Context context, AttributeSet attrs) {
        this(context, attrs, C1130R.attr.materialCardViewStyle);
    }
    ...
    public MaterialCardView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray attributes = ThemeEnforcement.obtainStyledAttributes(getContext(), attrs, C1130R.styleable.MaterialCardView, defStyleAttr, DEF_STYLE_RES, new int[0]);
