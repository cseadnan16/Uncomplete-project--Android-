...
public class AppBarLayout extends LinearLayout implements CoordinatorLayout.AttachedBehavior {
    private static final int DEF_STYLE_RES = C1130R.style.Widget_Design_AppBarLayout;
    ...
    public AppBarLayout(Context context, AttributeSet attrs) {
        this(context, attrs, C1130R.attr.appBarLayoutStyle);
    }
    ...
    public AppBarLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = ThemeEnforcement.obtainStyledAttributes(context2, attrs, C1130R.styleable.AppBarLayout, defStyleAttr, DEF_STYLE_RES, new int[0]);
        ViewCompat.setBackground(this, a.getDrawable(C1130R.styleable.AppBarLayout_android_background));
        ...
        if (a.hasValue(C1130R.styleable.AppBarLayout_expanded)) {
            setExpanded(a.getBoolean(C1130R.styleable.AppBarLayout_expanded, false), false, false);
        }
        if (Build.VERSION.SDK_INT >= 21 && a.hasValue(C1130R.styleable.AppBarLayout_elevation)) {
            ViewUtilsLollipop.setDefaultAppBarLayoutStateListAnimator(this, (float) a.getDimensionPixelSize(C1130R.styleable.AppBarLayout_elevation, 0));
        }
        if (Build.VERSION.SDK_INT >= 26) {
            if (a.hasValue(C1130R.styleable.AppBarLayout_android_keyboardNavigationCluster)) {
                setKeyboardNavigationCluster(a.getBoolean(C1130R.styleable.AppBarLayout_android_keyboardNavigationCluster, false));
            }
            if (a.hasValue(C1130R.styleable.AppBarLayout_android_touchscreenBlocksFocus)) {
                setTouchscreenBlocksFocus(a.getBoolean(C1130R.styleable.AppBarLayout_android_touchscreenBlocksFocus, false));
            }
        }
        this.liftOnScroll = a.getBoolean(C1130R.styleable.AppBarLayout_liftOnScroll, false);
        this.liftOnScrollTargetViewId = a.getResourceId(C1130R.styleable.AppBarLayout_liftOnScrollTargetViewId, -1);
        setStatusBarForeground(a.getDrawable(C1130R.styleable.AppBarLayout_statusBarForeground));
        a.recycle();
    ...
    public int[] onCreateDrawableState(int extraSpace) {
        ...
        extraStates[0] = this.liftable ? C1130R.attr.state_liftable : -C1130R.attr.state_liftable;
        extraStates[1] = (!this.liftable || !this.lifted) ? -C1130R.attr.state_lifted : C1130R.attr.state_lifted;
        extraStates[2] = this.liftable ? C1130R.attr.state_collapsible : -C1130R.attr.state_collapsible;
        extraStates[3] = (!this.liftable || !this.lifted) ? -C1130R.attr.state_collapsed : C1130R.attr.state_collapsed;
    ...
    private void startLiftOnScrollElevationOverlayAnimation(final MaterialShapeDrawable background, boolean lifted2) {
        float appBarElevation = getResources().getDimension(C1130R.dimen.design_appbar_elevation);
        ...
        ofFloat.setDuration((long) getResources().getInteger(C1130R.integer.app_bar_elevation_anim_duration));
    ...
    public static class LayoutParams extends LinearLayout.LayoutParams {
        ...
        public LayoutParams(Context c, AttributeSet attrs) {
            super(c, attrs);
            TypedArray a = c.obtainStyledAttributes(attrs, C1130R.styleable.AppBarLayout_Layout);
            this.scrollFlags = a.getInt(C1130R.styleable.AppBarLayout_Layout_layout_scrollFlags, 0);
            if (a.hasValue(C1130R.styleable.AppBarLayout_Layout_layout_scrollInterpolator)) {
                this.scrollInterpolator = android.view.animation.AnimationUtils.loadInterpolator(c, a.getResourceId(C1130R.styleable.AppBarLayout_Layout_layout_scrollInterpolator, 0));
            }
            a.recycle();
        }
    ...
    public static class ScrollingViewBehavior extends HeaderScrollingViewBehavior {
        ...
        public ScrollingViewBehavior(Context context, AttributeSet attrs) {
            super(context, attrs);
            TypedArray a = context.obtainStyledAttributes(attrs, C1130R.styleable.ScrollingViewBehavior_Layout);
            setOverlayTop(a.getDimensionPixelSize(C1130R.styleable.ScrollingViewBehavior_Layout_behavior_overlapTop, 0));
            a.recycle();
        }
