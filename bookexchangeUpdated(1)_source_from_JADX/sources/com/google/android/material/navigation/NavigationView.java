...
public class NavigationView extends ScrimInsetsFrameLayout {
    ...
    private static final int DEF_STYLE_RES = C1130R.style.Widget_Design_NavigationView;
    ...
    public NavigationView(Context context, AttributeSet attrs) {
        this(context, attrs, C1130R.attr.navigationViewStyle);
    }
    ...
    public NavigationView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TintTypedArray a = ThemeEnforcement.obtainTintedStyledAttributes(context2, attrs, C1130R.styleable.NavigationView, defStyleAttr, DEF_STYLE_RES, new int[0]);
        if (a.hasValue(C1130R.styleable.NavigationView_android_background)) {
            ViewCompat.setBackground(this, a.getDrawable(C1130R.styleable.NavigationView_android_background));
        }
        ...
        if (a.hasValue(C1130R.styleable.NavigationView_elevation)) {
            setElevation((float) a.getDimensionPixelSize(C1130R.styleable.NavigationView_elevation, 0));
        }
        setFitsSystemWindows(a.getBoolean(C1130R.styleable.NavigationView_android_fitsSystemWindows, false));
        this.maxWidth = a.getDimensionPixelSize(C1130R.styleable.NavigationView_android_maxWidth, 0);
        if (a.hasValue(C1130R.styleable.NavigationView_itemIconTint)) {
            itemIconTint = a.getColorStateList(C1130R.styleable.NavigationView_itemIconTint);
        } else {
            itemIconTint = createDefaultColorStateList(16842808);
        }
        boolean textAppearanceSet = false;
        int textAppearance = 0;
        if (a.hasValue(C1130R.styleable.NavigationView_itemTextAppearance)) {
            textAppearance = a.getResourceId(C1130R.styleable.NavigationView_itemTextAppearance, 0);
            textAppearanceSet = true;
        }
        if (a.hasValue(C1130R.styleable.NavigationView_itemIconSize)) {
            setItemIconSize(a.getDimensionPixelSize(C1130R.styleable.NavigationView_itemIconSize, 0));
        }
        ColorStateList itemTextColor = a.hasValue(C1130R.styleable.NavigationView_itemTextColor) ? a.getColorStateList(C1130R.styleable.NavigationView_itemTextColor) : null;
        if (!textAppearanceSet && itemTextColor == null) {
            itemTextColor = createDefaultColorStateList(16842806);
        }
        Drawable itemBackground = a.getDrawable(C1130R.styleable.NavigationView_itemBackground);
        if (itemBackground == null && hasShapeAppearance(a)) {
            itemBackground = createDefaultItemBackground(a);
        }
        if (a.hasValue(C1130R.styleable.NavigationView_itemHorizontalPadding)) {
            this.presenter.setItemHorizontalPadding(a.getDimensionPixelSize(C1130R.styleable.NavigationView_itemHorizontalPadding, 0));
        }
        int itemIconPadding = a.getDimensionPixelSize(C1130R.styleable.NavigationView_itemIconPadding, 0);
        setItemMaxLines(a.getInt(C1130R.styleable.NavigationView_itemMaxLines, 1));
        ...
        if (a.hasValue(C1130R.styleable.NavigationView_menu)) {
            inflateMenu(a.getResourceId(C1130R.styleable.NavigationView_menu, 0));
        }
        if (a.hasValue(C1130R.styleable.NavigationView_headerLayout)) {
            inflateHeaderView(a.getResourceId(C1130R.styleable.NavigationView_headerLayout, 0));
        }
        a.recycle();
    ...
    private boolean hasShapeAppearance(TintTypedArray a) {
        return a.hasValue(C1130R.styleable.NavigationView_itemShapeAppearance) || a.hasValue(C1130R.styleable.NavigationView_itemShapeAppearanceOverlay);
    }
    ...
    private final Drawable createDefaultItemBackground(TintTypedArray a) {
        MaterialShapeDrawable materialShapeDrawable = new MaterialShapeDrawable(ShapeAppearanceModel.builder(getContext(), a.getResourceId(C1130R.styleable.NavigationView_itemShapeAppearance, 0), a.getResourceId(C1130R.styleable.NavigationView_itemShapeAppearanceOverlay, 0)).build());
        materialShapeDrawable.setFillColor(MaterialResources.getColorStateList(getContext(), a, C1130R.styleable.NavigationView_itemShapeFillColor));
        return new InsetDrawable(materialShapeDrawable, a.getDimensionPixelSize(C1130R.styleable.NavigationView_itemShapeInsetStart, 0), a.getDimensionPixelSize(C1130R.styleable.NavigationView_itemShapeInsetTop, 0), a.getDimensionPixelSize(C1130R.styleable.NavigationView_itemShapeInsetEnd, 0), a.getDimensionPixelSize(C1130R.styleable.NavigationView_itemShapeInsetBottom, 0));
    }
    ...
    private ColorStateList createDefaultColorStateList(int baseColorThemeAttr) {
        ...
        if (!getContext().getTheme().resolveAttribute(C0987R.attr.colorPrimary, value, true)) {
            return null;
        }
