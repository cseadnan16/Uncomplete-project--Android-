...
public class ChipGroup extends FlowLayout {
    private static final int DEF_STYLE_RES = C1130R.style.Widget_MaterialComponents_ChipGroup;
    ...
    public ChipGroup(Context context, AttributeSet attrs) {
        this(context, attrs, C1130R.attr.chipGroupStyle);
    }
    ...
    public ChipGroup(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = ThemeEnforcement.obtainStyledAttributes(getContext(), attrs, C1130R.styleable.ChipGroup, defStyleAttr, DEF_STYLE_RES, new int[0]);
        int chipSpacing = a.getDimensionPixelOffset(C1130R.styleable.ChipGroup_chipSpacing, 0);
        setChipSpacingHorizontal(a.getDimensionPixelOffset(C1130R.styleable.ChipGroup_chipSpacingHorizontal, chipSpacing));
        setChipSpacingVertical(a.getDimensionPixelOffset(C1130R.styleable.ChipGroup_chipSpacingVertical, chipSpacing));
        setSingleLine(a.getBoolean(C1130R.styleable.ChipGroup_singleLine, false));
        setSingleSelection(a.getBoolean(C1130R.styleable.ChipGroup_singleSelection, false));
        setSelectionRequired(a.getBoolean(C1130R.styleable.ChipGroup_selectionRequired, false));
        int checkedChip = a.getResourceId(C1130R.styleable.ChipGroup_checkedChip, -1);
        if (checkedChip != -1) {
