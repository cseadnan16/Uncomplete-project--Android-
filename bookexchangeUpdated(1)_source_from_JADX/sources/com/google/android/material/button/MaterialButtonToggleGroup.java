...
public class MaterialButtonToggleGroup extends LinearLayout {
    private static final int DEF_STYLE_RES = C1130R.style.Widget_MaterialComponents_MaterialButtonToggleGroup;
    ...
    public MaterialButtonToggleGroup(Context context, AttributeSet attrs) {
        this(context, attrs, C1130R.attr.materialButtonToggleGroupStyle);
    }
    ...
    public MaterialButtonToggleGroup(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray attributes = ThemeEnforcement.obtainStyledAttributes(getContext(), attrs, C1130R.styleable.MaterialButtonToggleGroup, defStyleAttr, DEF_STYLE_RES, new int[0]);
        setSingleSelection(attributes.getBoolean(C1130R.styleable.MaterialButtonToggleGroup_singleSelection, false));
        this.checkedId = attributes.getResourceId(C1130R.styleable.MaterialButtonToggleGroup_checkedButton, -1);
        this.selectionRequired = attributes.getBoolean(C1130R.styleable.MaterialButtonToggleGroup_selectionRequired, false);
    ...
    public void updateCheckedStates(int childId, boolean childIsChecked) {
        ...
        } else if (childIsChecked && this.singleSelection) {
