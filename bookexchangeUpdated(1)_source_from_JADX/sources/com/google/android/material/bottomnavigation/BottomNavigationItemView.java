...
public class BottomNavigationItemView extends FrameLayout implements MenuView.ItemView {
    ...
    public BottomNavigationItemView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        LayoutInflater.from(context).inflate(C1130R.layout.design_bottom_navigation_item, this, true);
        setBackgroundResource(C1130R.C1132drawable.design_bottom_navigation_item_background);
        this.defaultMargin = res.getDimensionPixelSize(C1130R.dimen.design_bottom_navigation_margin);
        this.icon = (ImageView) findViewById(C1130R.C1133id.icon);
        this.smallLabel = (TextView) findViewById(C1130R.C1133id.smallLabel);
        this.largeLabel = (TextView) findViewById(C1130R.C1133id.largeLabel);
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo info) {
        ...
        infoCompat.setCollectionItemInfo(AccessibilityNodeInfoCompat.CollectionItemInfoCompat.obtain(0, 1, getItemPosition(), 1, false, isSelected()));
        if (isSelected()) {
