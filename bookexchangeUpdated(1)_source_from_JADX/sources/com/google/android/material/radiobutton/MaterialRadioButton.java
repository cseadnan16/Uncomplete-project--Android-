...
public class MaterialRadioButton extends AppCompatRadioButton {
    private static final int DEF_STYLE_RES = C1130R.style.Widget_MaterialComponents_CompoundButton_RadioButton;
    ...
    public MaterialRadioButton(Context context, AttributeSet attrs) {
        this(context, attrs, C1130R.attr.radioButtonStyle);
    }

    public MaterialRadioButton(Context context, AttributeSet attrs, int defStyleAttr) {
        super(MaterialThemeOverlay.wrap(context, attrs, defStyleAttr, DEF_STYLE_RES), attrs, defStyleAttr);
        TypedArray attributes = ThemeEnforcement.obtainStyledAttributes(getContext(), attrs, C1130R.styleable.MaterialRadioButton, defStyleAttr, DEF_STYLE_RES, new int[0]);
        this.useMaterialThemeColors = attributes.getBoolean(C1130R.styleable.MaterialRadioButton_useMaterialThemeColors, false);
        attributes.recycle();
    }
