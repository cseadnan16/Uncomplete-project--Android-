...
public class BottomAppBar extends Toolbar implements CoordinatorLayout.AttachedBehavior {
    ...
    private static final int DEF_STYLE_RES = C1130R.style.Widget_MaterialComponents_BottomAppBar;
    ...
    public BottomAppBar(Context context, AttributeSet attrs) {
        this(context, attrs, C1130R.attr.bottomAppBarStyle);
    }
    ...
    public BottomAppBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = ThemeEnforcement.obtainStyledAttributes(context2, attrs, C1130R.styleable.BottomAppBar, defStyleAttr, DEF_STYLE_RES, new int[0]);
        ColorStateList backgroundTint = MaterialResources.getColorStateList(context2, a, C1130R.styleable.BottomAppBar_backgroundTint);
        int elevation = a.getDimensionPixelSize(C1130R.styleable.BottomAppBar_elevation, 0);
        this.fabAlignmentMode = a.getInt(C1130R.styleable.BottomAppBar_fabAlignmentMode, 0);
        this.fabAnimationMode = a.getInt(C1130R.styleable.BottomAppBar_fabAnimationMode, 0);
        this.hideOnScroll = a.getBoolean(C1130R.styleable.BottomAppBar_hideOnScroll, false);
        this.paddingBottomSystemWindowInsets = a.getBoolean(C1130R.styleable.BottomAppBar_paddingBottomSystemWindowInsets, false);
        this.paddingLeftSystemWindowInsets = a.getBoolean(C1130R.styleable.BottomAppBar_paddingLeftSystemWindowInsets, false);
        this.paddingRightSystemWindowInsets = a.getBoolean(C1130R.styleable.BottomAppBar_paddingRightSystemWindowInsets, false);
        a.recycle();
        this.fabOffsetEndMode = getResources().getDimensionPixelOffset(C1130R.dimen.mtrl_bottomappbar_fabOffsetEndMode);
        this.materialShapeDrawable.setShapeAppearanceModel(ShapeAppearanceModel.builder().setTopEdge(new BottomAppBarTopEdgeTreatment((float) a.getDimensionPixelOffset(C1130R.styleable.BottomAppBar_fabCradleMargin, 0), (float) a.getDimensionPixelOffset(C1130R.styleable.BottomAppBar_fabCradleRoundedCornerRadius, 0), (float) a.getDimensionPixelOffset(C1130R.styleable.BottomAppBar_fabCradleVerticalOffset, 0))).build());
        ...
        private final View.OnLayoutChangeListener fabLayoutListener = new View.OnLayoutChangeListener() {
            public void onLayoutChange(View v, int left, int top, int right, int bottom, int oldLeft, int oldTop, int oldRight, int oldBottom) {
                ...
                if (Behavior.this.originalBottomMargin == 0) {
                    fabLayoutParams.bottomMargin = child.getBottomInset() + (child.getResources().getDimensionPixelOffset(C1130R.dimen.mtrl_bottomappbar_fab_bottom_margin) - ((fab.getMeasuredHeight() - height) / 2));
