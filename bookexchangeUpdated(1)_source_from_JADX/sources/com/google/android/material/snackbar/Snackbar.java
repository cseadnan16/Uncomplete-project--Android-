...
public class Snackbar extends BaseTransientBottomBar<Snackbar> {
    private static final int[] SNACKBAR_BUTTON_STYLE_ATTR = {C1130R.attr.snackbarButtonStyle};
    private static final int[] SNACKBAR_CONTENT_STYLE_ATTRS = {C1130R.attr.snackbarButtonStyle, C1130R.attr.snackbarTextViewStyle};
    ...
    public static Snackbar make(View view, CharSequence text, int duration) {
        ...
        if (parent != null) {
            SnackbarContentLayout content = (SnackbarContentLayout) LayoutInflater.from(parent.getContext()).inflate(hasSnackbarContentStyleAttrs(parent.getContext()) ? C1130R.layout.mtrl_layout_snackbar_include : C1130R.layout.design_layout_snackbar_include, parent, false);
