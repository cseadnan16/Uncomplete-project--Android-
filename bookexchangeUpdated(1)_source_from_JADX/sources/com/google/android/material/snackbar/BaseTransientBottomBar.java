...
public abstract class BaseTransientBottomBar<B extends BaseTransientBottomBar<B>> {
    ...
    private static final int[] SNACKBAR_STYLE_ATTR = {C1130R.attr.snackbarStyle};
    ...
    public void updateMargins() {
        ...
        ViewGroup.MarginLayoutParams marginParams = (ViewGroup.MarginLayoutParams) layoutParams;
        marginParams.bottomMargin = this.originalMargins.bottom + (this.anchorView != null ? this.extraBottomMarginAnchorView : this.extraBottomMarginWindowInset);
    ...
    public int getSnackbarBaseLayoutResId() {
        return hasSnackbarStyleAttr() ? C1130R.layout.mtrl_layout_snackbar : C1130R.layout.design_layout_snackbar;
    }
    ...
    protected static class SnackbarBaseLayout extends FrameLayout {
        ...
        protected SnackbarBaseLayout(Context context, AttributeSet attrs) {
            ...
            TypedArray a = context2.obtainStyledAttributes(attrs, C1130R.styleable.SnackbarLayout);
            if (a.hasValue(C1130R.styleable.SnackbarLayout_elevation)) {
                ViewCompat.setElevation(this, (float) a.getDimensionPixelSize(C1130R.styleable.SnackbarLayout_elevation, 0));
            }
            this.animationMode = a.getInt(C1130R.styleable.SnackbarLayout_animationMode, 0);
            this.backgroundOverlayColorAlpha = a.getFloat(C1130R.styleable.SnackbarLayout_backgroundOverlayColorAlpha, 1.0f);
            setBackgroundTintList(MaterialResources.getColorStateList(context2, a, C1130R.styleable.SnackbarLayout_backgroundTint));
            setBackgroundTintMode(ViewUtils.parseTintMode(a.getInt(C1130R.styleable.SnackbarLayout_backgroundTintMode, -1), PorterDuff.Mode.SRC_IN));
            this.actionTextColorAlpha = a.getFloat(C1130R.styleable.SnackbarLayout_actionTextColorAlpha, 1.0f);
            a.recycle();
        ...
        private Drawable createThemedBackground() {
            float cornerRadius = getResources().getDimension(C1130R.dimen.mtrl_snackbar_background_corner_radius);
            GradientDrawable background = new GradientDrawable();
            background.setShape(0);
            background.setCornerRadius(cornerRadius);
            background.setColor(MaterialColors.layer(this, C1130R.attr.colorSurface, C1130R.attr.colorOnSurface, getBackgroundOverlayColorAlpha()));
