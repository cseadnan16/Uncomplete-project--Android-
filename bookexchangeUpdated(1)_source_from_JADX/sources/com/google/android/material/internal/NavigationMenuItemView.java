...
public class NavigationMenuItemView extends ForegroundLinearLayout implements MenuView.ItemView {
    ...
    public NavigationMenuItemView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        setOrientation(0);
        LayoutInflater.from(context).inflate(C1130R.layout.design_navigation_menu_item, this, true);
        setIconSize(context.getResources().getDimensionPixelSize(C1130R.dimen.design_navigation_icon_size));
        CheckedTextView checkedTextView = (CheckedTextView) findViewById(C1130R.C1133id.design_menu_item_text);
    ...
    private void setActionView(View actionView) {
        if (actionView != null) {
            if (this.actionArea == null) {
                this.actionArea = (FrameLayout) ((ViewStub) findViewById(C1130R.C1133id.design_menu_item_action_area_stub)).inflate();
            }
    ...
    private StateListDrawable createDefaultBackground() {
        ...
        if (!getContext().getTheme().resolveAttribute(C0987R.attr.colorControlHighlight, value, true)) {
            return null;
        }
    ...
    public void setIcon(Drawable icon) {
        if (icon != null) {
            ...
            if (this.emptyDrawable == null) {
                Drawable drawable = ResourcesCompat.getDrawable(getResources(), C1130R.C1132drawable.navigation_empty_icon, getContext().getTheme());
