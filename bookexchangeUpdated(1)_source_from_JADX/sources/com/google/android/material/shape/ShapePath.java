...
public class ShapePath {
    ...
    public void lineTo(float x, float y) {
        ...
        float unused = operation.f60x = x;
        float unused2 = operation.f61y = y;
    ...
    static class LineShadowOperation extends ShadowCompatOperation {
        ...
        public void draw(Matrix transform, ShadowRenderer shadowRenderer, int shadowElevation, Canvas canvas) {
            RectF rect = new RectF(0.0f, 0.0f, (float) Math.hypot((double) (this.operation.f61y - this.startY), (double) (this.operation.f60x - this.startX)), 0.0f);
        ...
        public float getAngle() {
            return (float) Math.toDegrees(Math.atan((double) ((this.operation.f61y - this.startY) / (this.operation.f60x - this.startX))));
        }
    }
