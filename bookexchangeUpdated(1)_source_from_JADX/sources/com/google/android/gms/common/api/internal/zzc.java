...
public final class zzc extends C0198Fragment implements LifecycleFragment {
    ...
    public static zzc zza(FragmentActivity fragmentActivity) {
        ...
        try {
            ...
            if (zzc2 == null || zzc2.isRemoving()) {
                zzc2 = new zzc();
                fragmentActivity.getSupportFragmentManager().beginTransaction().add((C0198Fragment) zzc2, "SupportLifecycleFragmentImpl").commitAllowingStateLoss();
            }
