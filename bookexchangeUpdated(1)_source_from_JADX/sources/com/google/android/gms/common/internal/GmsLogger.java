...
public final class GmsLogger {
    ...
    /* renamed from: d */
    public final void mo11096d(String str, String str2) {
        if (canLog(3)) {
            Log.d(str, zzh(str2));
        }
    }
    ...
    /* renamed from: d */
    public final void mo11097d(String str, String str2, Throwable th) {
        if (canLog(3)) {
    ...
    /* renamed from: v */
    public final void mo11105v(String str, String str2) {
        if (canLog(2)) {
            Log.v(str, zzh(str2));
        }
    }
    ...
    /* renamed from: v */
    public final void mo11106v(String str, String str2, Throwable th) {
        if (canLog(2)) {
    ...
    /* renamed from: i */
    public final void mo11101i(String str, String str2) {
        if (canLog(4)) {
            Log.i(str, zzh(str2));
        }
    }
    ...
    /* renamed from: i */
    public final void mo11102i(String str, String str2, Throwable th) {
        if (canLog(4)) {
    ...
    /* renamed from: w */
    public final void mo11107w(String str, String str2) {
        if (canLog(5)) {
            Log.w(str, zzh(str2));
        }
    }
    ...
    /* renamed from: w */
    public final void mo11108w(String str, String str2, Throwable th) {
        if (canLog(5)) {
    ...
    /* renamed from: e */
    public final void mo11098e(String str, String str2) {
        if (canLog(6)) {
            Log.e(str, zzh(str2));
        }
    }
    ...
    /* renamed from: e */
    public final void mo11099e(String str, String str2, Throwable th) {
        if (canLog(6)) {
