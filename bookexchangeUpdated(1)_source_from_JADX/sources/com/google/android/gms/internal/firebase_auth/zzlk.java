...
final class zzlk extends zzlj {
    ...
    public final int zza(int r16, byte[] r17, int r18, int r19) {
        ...
        L_0x00bf:
            ...
            throw r3
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.firebase_auth.zzlk.zza(int, byte[], int, int):int");
    }
            ...
            while (r13 < i3) {
                ...
                if (zzlg.zzd(zza2)) {
                    ...
                    while (i6 < i3) {
                        ...
                        i6++;
                        zzlg.zzb(zza3, cArr, i7);
                        i7++;
                    }
                    r13 = i6;
                    i5 = i7;
                } else if (zzlg.zze(zza2)) {
                    if (i6 < i3) {
                        int i8 = i6 + 1;
                        zzlg.zzb(zza2, zzlf.zza(bArr, (long) i6), cArr, i5);
                        r13 = i8;
                        i5++;
                    } else {
                        throw zzin.zzi();
                    }
                } else if (zzlg.zzf(zza2)) {
                    if (i6 < i3 - 1) {
                        int i9 = i6 + 1;
                        int i10 = i9 + 1;
                        zzlg.zzb(zza2, zzlf.zza(bArr, (long) i6), zzlf.zza(bArr, (long) i9), cArr, i5);
                        r13 = i10;
                        i5++;
                    } else {
                        throw zzin.zzi();
                    ...
                    int i12 = i11 + 1;
                    zzlg.zzb(zza2, zza4, zzlf.zza(bArr, (long) i11), zzlf.zza(bArr, (long) i12), cArr, i5);
                    r13 = i12 + 1;
                    i5 = i5 + 1 + 1;
                } else {
                    throw zzin.zzi();
    ...
    public final int zza(java.lang.CharSequence r23, byte[] r24, int r25, int r26) {
        ...
        L_0x0148:
            ...
            throw r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.firebase_auth.zzlk.zza(java.lang.CharSequence, byte[], int, int):int");
    }
    ...
    private static int zza(byte[] bArr, int i, long j, int i2) {
        ...
        if (i2 == 1) {
            return zzlh.zzb(i, zzlf.zza(bArr, j));
        }
        if (i2 == 2) {
            return zzlh.zzb(i, (int) zzlf.zza(bArr, j), (int) zzlf.zza(bArr, j + 1));
        }
