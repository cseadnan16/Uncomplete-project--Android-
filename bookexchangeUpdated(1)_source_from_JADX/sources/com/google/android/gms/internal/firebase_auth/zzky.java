...
public final class zzky {
    ...
    static zzky zza(zzky zzky, zzky zzky2) {
        int i = zzky.zzb + zzky2.zzb;
        int[] copyOf = Arrays.copyOf(zzky.zzc, i);
        System.arraycopy(zzky2.zzc, 0, copyOf, zzky.zzb, zzky2.zzb);
        Object[] copyOf2 = Arrays.copyOf(zzky.zzd, i);
        System.arraycopy(zzky2.zzd, 0, copyOf2, zzky.zzb, zzky2.zzb);
    ...
    public final void zza(zzls zzls) throws IOException {
        if (zzls.zza() == zzif.zzf.zzk) {
            for (int i = this.zzb - 1; i >= 0; i--) {
                zzls.zza(this.zzc[i] >>> 3, this.zzd[i]);
            }
            return;
        }
        for (int i2 = 0; i2 < this.zzb; i2++) {
            zzls.zza(this.zzc[i2] >>> 3, this.zzd[i2]);
        }
    }

    public final void zzb(zzls zzls) throws IOException {
        if (this.zzb != 0) {
            if (zzls.zza() == zzif.zzf.zzj) {
                for (int i = 0; i < this.zzb; i++) {
                    zza(this.zzc[i], this.zzd[i], zzls);
                }
                return;
            }
            for (int i2 = this.zzb - 1; i2 >= 0; i2--) {
                zza(this.zzc[i2], this.zzd[i2], zzls);
            }
        }
    }
    ...
    private static void zza(int i, Object obj, zzls zzls) throws IOException {
        ...
        int i3 = i & 7;
        if (i3 == 0) {
            zzls.zza(i2, ((Long) obj).longValue());
        } else if (i3 == 1) {
            zzls.zzd(i2, ((Long) obj).longValue());
        } else if (i3 == 2) {
            zzls.zza(i2, (zzgv) obj);
        } else if (i3 != 3) {
            if (i3 == 5) {
                zzls.zzd(i2, ((Integer) obj).intValue());
                return;
            }
            throw new RuntimeException(zzin.zzf());
        } else if (zzls.zza() == zzif.zzf.zzj) {
            zzls.zza(i2);
            ((zzky) obj).zzb(zzls);
            zzls.zzb(i2);
        } else {
