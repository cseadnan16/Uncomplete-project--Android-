...
final class zzjb extends zzgr<Long> implements zzio<Long>, zzka, RandomAccess {
    ...
    public final boolean addAll(Collection<? extends Long> collection) {
        ...
        if (Integer.MAX_VALUE - i2 >= i) {
            ...
            System.arraycopy(zzjb.zzb, 0, this.zzb, this.zzc, zzjb.zzc);
            this.zzc = i3;
            this.modCount++;
            return true;
        }
    ...
    public final /* synthetic */ zzio zza(int i) {
        if (i >= this.zzc) {
            return new zzjb(Arrays.copyOf(this.zzb, i), this.zzc);
        }
