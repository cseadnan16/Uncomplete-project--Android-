...
interface zzls {
    ...
    void zza(int i, zzgv zzgv) throws IOException;

    <K, V> void zza(int i, zzji<K, V> zzji, Map<K, V> map) throws IOException;

    void zza(int i, Object obj) throws IOException;

    void zza(int i, Object obj, zzkd zzkd) throws IOException;

    void zza(int i, String str) throws IOException;

    void zza(int i, List<String> list) throws IOException;

    void zza(int i, List<?> list, zzkd zzkd) throws IOException;
    ...
    @Deprecated
    void zzb(int i, Object obj, zzkd zzkd) throws IOException;

    void zzb(int i, List<zzgv> list) throws IOException;

    @Deprecated
    void zzb(int i, List<?> list, zzkd zzkd) throws IOException;
