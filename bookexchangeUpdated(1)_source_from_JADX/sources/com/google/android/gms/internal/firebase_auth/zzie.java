...
abstract class zzie<T extends zzhs> {
    ...
    static <T extends zzhs> T zza(Class<T> cls) {
        String str;
        ...
        try {
            return (zzhs) cls.cast(((zzie) Class.forName(str, true, classLoader).getConstructor(new Class[0]).newInstance(new Object[0])).zza());
            ...
            if (arrayList.size() == 1) {
                return (zzhs) arrayList.get(0);
            }
            if (arrayList.size() == 0) {
                return null;
            }
            try {
                return (zzhs) cls.getMethod("combine", new Class[]{Collection.class}).invoke((Object) null, new Object[]{arrayList});
