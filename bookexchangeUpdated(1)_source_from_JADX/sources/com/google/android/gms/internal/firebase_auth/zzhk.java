...
final class zzhk implements zzke {
    private final zzhh zza;
    private int zzb;
    private int zzc;
    private int zzd = 0;

    public static zzhk zza(zzhh zzhh) {
        if (zzhh.zzd != null) {
            return zzhh.zzd;
        }
        return new zzhk(zzhh);
    }

    private zzhk(zzhh zzhh) {
    ...
    public final <T> T zza(zzkd<T> zzkd, zzhs zzhs) throws IOException {
        zza(2);
        return zzc(zzkd, zzhs);
    }

    public final <T> T zzb(zzkd<T> zzkd, zzhs zzhs) throws IOException {
        zza(3);
        return zzd(zzkd, zzhs);
    }

    private final <T> T zzc(zzkd<T> zzkd, zzhs zzhs) throws IOException {
        int zzm = this.zza.zzm();
        if (this.zza.zza < this.zza.zzb) {
            int zzc2 = this.zza.zzc(zzm);
            T zza2 = zzkd.zza();
            this.zza.zza++;
            zzkd.zza(zza2, this, zzhs);
            zzkd.zzc(zza2);
            this.zza.zza(0);
            zzhh zzhh = this.zza;
            zzhh.zza--;
    ...
    private final <T> T zzd(zzkd<T> zzkd, zzhs zzhs) throws IOException {
        int i = this.zzc;
    ...
    public final <T> void zza(List<T> list, zzkd<T> zzkd, zzhs zzhs) throws IOException {
        int zza2;
        int i = this.zzb;
        if ((i & 7) == 2) {
            do {
                list.add(zzc(zzkd, zzhs));
    ...
    public final <T> void zzb(List<T> list, zzkd<T> zzkd, zzhs zzhs) throws IOException {
        int zza2;
        int i = this.zzb;
        if ((i & 7) == 3) {
            do {
                list.add(zzd(zzkd, zzhs));
                if (!this.zza.zzt() && this.zzd == 0) {
                    zza2 = this.zza.zza();
                } else {
                    return;
    ...
    public final <K, V> void zza(Map<K, V> map, zzji<K, V> zzji, zzhs zzhs) throws IOException {
        zza(2);
        ...
        while (true) {
            try {
                ...
                if (zza2 == Integer.MAX_VALUE || this.zza.zzt()) {
                    ...
                    k = zza(zzji.zza, (Class<?>) null, (zzhs) null);
                } else if (zza2 == 2) {
                    v = zza(zzji.zzc, zzji.zzd.getClass(), zzhs);
                } else if (!zzc()) {
    ...
    private final Object zza(zzlm zzlm, Class<?> cls, zzhs zzhs) throws IOException {
        switch (zzhn.zza[zzlm.ordinal()]) {
            case 1:
            ...
            case 10:
                zza(2);
                return zzc(zzjz.zza().zza(cls), zzhs);
            case 11:
