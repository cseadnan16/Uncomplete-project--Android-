...
public abstract class zzhm extends zzgs {
    ...
    public abstract void zza(int i, zzjn zzjn, zzkd zzkd) throws IOException;
    ...
    public abstract void zza(zzjn zzjn) throws IOException;
    ...
    static class zza extends zzhm {
        ...
        /* access modifiers changed from: package-private */
        public final void zza(int i, zzjn zzjn, zzkd zzkd) throws IOException {
            zza(i, 2);
            zzgn zzgn = (zzgn) zzjn;
            int zzy = zzgn.zzy();
            if (zzy == -1) {
    ...
    static int zzb(int i, zzjn zzjn, zzkd zzkd) {
        return zze(i) + zza(zzjn, zzkd);
    }

    public static int zzb(int i, zzjn zzjn) {
        return (zze(1) << 1) + zzg(2, i) + zze(3) + zzb(zzjn);
    }
    ...
    public static int zzb(zzjn zzjn) {
        int zzaa = zzjn.zzaa();
        return zzg(zzaa) + zzaa;
    }

    static int zza(zzjn zzjn, zzkd zzkd) {
        zzgn zzgn = (zzgn) zzjn;
        int zzy = zzgn.zzy();
        if (zzy == -1) {
            zzy = zzkd.zzb(zzgn);
    ...
    @Deprecated
    static int zzc(int i, zzjn zzjn, zzkd zzkd) {
        int zze = zze(i) << 1;
        zzgn zzgn = (zzgn) zzjn;
        int zzy = zzgn.zzy();
        if (zzy == -1) {
