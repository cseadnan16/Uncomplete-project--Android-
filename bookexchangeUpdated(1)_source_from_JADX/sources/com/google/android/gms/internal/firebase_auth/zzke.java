...
interface zzke {
    ...
    <T> T zza(zzkd<T> zzkd, zzhs zzhs) throws IOException;

    void zza(List<Double> list) throws IOException;

    <T> void zza(List<T> list, zzkd<T> zzkd, zzhs zzhs) throws IOException;

    <K, V> void zza(Map<K, V> map, zzji<K, V> zzji, zzhs zzhs) throws IOException;

    int zzb();

    @Deprecated
    <T> T zzb(zzkd<T> zzkd, zzhs zzhs) throws IOException;

    void zzb(List<Float> list) throws IOException;

    @Deprecated
    <T> void zzb(List<T> list, zzkd<T> zzkd, zzhs zzhs) throws IOException;
    ...
    void zzk(List<zzgv> list) throws IOException;
