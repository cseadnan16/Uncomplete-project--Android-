...
public class AppMeasurement {
    ...
    private static AppMeasurement zza(Context context, String str, String str2) {
        if (zza == null) {
            synchronized (AppMeasurement.class) {
                if (zza == null) {
                    zzio zzb2 = zzb(context, (Bundle) null);
                    if (zzb2 != null) {
                        zza = new AppMeasurement(zzb2);
                    } else {
                        zza = new AppMeasurement(zzgo.zza(context, (String) null, (String) null, (Bundle) null));
                    }
                }
            }
        }
            ...
            synchronized (AppMeasurement.class) {
                if (zza == null) {
                    ...
                    if (zzb2 != null) {
                        ...
                        zza = new AppMeasurement(zzgo.zza(context, (String) null, (String) null, bundle));
                    }
                }
            }
        }
    ...
    private static zzio zzb(Context context, Bundle bundle) {
        try {
            try {
                return (zzio) Class.forName("com.google.firebase.analytics.FirebaseAnalytics").getDeclaredMethod("getScionFrontendApiImplementation", new Class[]{Context.class, Bundle.class}).invoke((Object) null, new Object[]{context, bundle});
            } catch (Exception e) {
                return null;
            }
    ...
    public void setEventInterceptor(EventInterceptor eventInterceptor) {
        if (this.zzd) {
            this.zzc.zza((zzho) eventInterceptor);
        } else {
            this.zzb.zzh().zza((zzho) eventInterceptor);
        }
    }

    public void registerOnMeasurementEventListener(OnEventListener onEventListener) {
        if (this.zzd) {
            this.zzc.zza((zzhn) onEventListener);
        } else {
            this.zzb.zzh().zza((zzhn) onEventListener);
        }
    }

    public void unregisterOnMeasurementEventListener(OnEventListener onEventListener) {
        if (this.zzd) {
            this.zzc.zzb((zzhn) onEventListener);
        } else {
            this.zzb.zzh().zzb((zzhn) onEventListener);
        }
    }
