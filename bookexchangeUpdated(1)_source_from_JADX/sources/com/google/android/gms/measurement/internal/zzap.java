...
public final class zzap {
    ...
    public static zzez<Integer> zzaf = zza("measurement.upload.max_public_user_properties", 25, 25, (zzex) null);
    public static zzez<Integer> zzag = zza("measurement.upload.max_event_name_cardinality", 500, 500, (zzex) null);
    ...
    public static zzez<Boolean> zzbg = zza("measurement.quality.checksum", false, false, (zzex) null);
    ...
    public static zzez<Long> zzt = zza("measurement.upload.realtime_upload_interval", 10000L, 10000L, zzbl.zza);
    ...
    static {
        ...
        zzae = zza("measurement.audience.filter_result_max_count", valueOf, valueOf, zzca.zza);
        Double valueOf2 = Double.valueOf(-3.0d);
        zzam = zza("measurement.test.double_flag", valueOf2, valueOf2, zzcg.zza);
    }
}
