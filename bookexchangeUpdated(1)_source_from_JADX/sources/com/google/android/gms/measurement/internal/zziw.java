...
public final class zziw extends zze {
    ...
    private final void zza(Activity activity, zzit zzit, boolean z) {
        zzit zzit2;
        zzit zzit3 = this.zzb == null ? this.zzc : this.zzb;
        if (zzit.zzb == null) {
            zzit2 = new zzit(zzit.zza, zza(activity.getClass().getCanonicalName()), zzit.zzc);
        } else {
            zzit2 = zzit;
        }
        this.zzc = this.zzb;
        this.zzb = zzit2;
        zzq().zza((Runnable) new zziv(this, z, zzm().elapsedRealtime(), zzit3, zzit2));
    }
    ...
    private final zzit zzd(Activity activity) {
        ...
        zzit zzit2 = new zzit((String) null, zza(activity.getClass().getCanonicalName()), zzp().zzg());
    ...
    public final void zzb(Activity activity) {
        ...
        this.zzc = this.zzb;
        this.zzb = null;
        zzq().zza((Runnable) new zziy(this, zzd2, zzm().elapsedRealtime()));
    }
