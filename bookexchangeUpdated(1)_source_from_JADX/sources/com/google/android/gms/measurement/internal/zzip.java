...
final class zzip implements Runnable {
    ...
    public final void run() {
        /*
            ...
            r0 = 0
            r1 = 0
            com.google.android.gms.measurement.internal.zzin r2 = r7.zzf     // Catch:{ IOException -> 0x006f, all -> 0x0063 }
        ...
        L_0x003c:
            ...
            com.google.android.gms.measurement.internal.zzin r4 = r7.zzf     // Catch:{ IOException -> 0x0058, all -> 0x0053 }
            byte[] r4 = com.google.android.gms.measurement.internal.zzin.zza((java.net.HttpURLConnection) r2)     // Catch:{ IOException -> 0x0058, all -> 0x0053 }
    ...
    private final void zzb(int i, Exception exc, byte[] bArr, Map<String, List<String>> map) {
        this.zzf.zzq().zza((Runnable) new zzis(this, i, exc, bArr, map));
    }
