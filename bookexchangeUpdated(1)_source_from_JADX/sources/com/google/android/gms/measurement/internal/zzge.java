...
public final class zzge {
    ...
    public final void zza(Context context, Intent intent) {
        zzgo zza2 = zzgo.zza(context, (zzv) null);
        zzfk zzr = zza2.zzr();
        if (intent == null) {
        ...
        if ("com.google.android.gms.measurement.UPLOAD".equals(action)) {
            ...
            try {
                zza2.zzq().zza((Runnable) new zzgd(this, zza2, zzr));
            } catch (Exception e) {
            ...
            zza2.zzq().zza((Runnable) new zzgg(this, zza2, longExtra, zza3, context, zzr, doGoAsync));
        }
    }
}
