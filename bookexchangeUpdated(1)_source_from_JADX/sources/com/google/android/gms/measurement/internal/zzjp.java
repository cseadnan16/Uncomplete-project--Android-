...
public final class zzjp implements ServiceConnection, BaseGmsClient.BaseConnectionCallbacks, BaseGmsClient.BaseOnConnectionFailedListener {
    ...
    public final void onServiceConnected(ComponentName componentName, IBinder iBinder) {
        ...
        synchronized (this) {
            ...
            try {
                ...
                if ("com.google.android.gms.measurement.internal.IMeasurementService".equals(interfaceDescriptor)) {
                    if (iBinder != null) {
                        ...
                        if (queryLocalInterface instanceof zzfc) {
                            zzfe = (zzfc) queryLocalInterface;
                        } else {
                            zzfe = new zzfe(iBinder);
                        }
                    }
            ...
            if (zzfe == null) {
                ...
                this.zza.zzq().zza((Runnable) new zzjs(this, zzfe));
            }
        }
    }
    ...
    public final void onServiceDisconnected(ComponentName componentName) {
        ...
        this.zza.zzq().zza((Runnable) new zzjr(this, componentName));
    }
    ...
    public final void onConnected(Bundle bundle) {
        ...
        synchronized (this) {
            try {
                this.zza.zzq().zza((Runnable) new zzju(this, (zzfc) this.zzc.getService()));
    ...
    public final void onConnectionSuspended(int i) {
        ...
        this.zza.zzq().zza((Runnable) new zzjt(this));
    }
    ...
    public final void onConnectionFailed(ConnectionResult connectionResult) {
        ...
        this.zza.zzq().zza((Runnable) new zzjw(this));
    }
}
