...
public final class zzjv<T extends Context & zzjz> {
    ...
    public final void zza() {
        zzgo zza2 = zzgo.zza((Context) this.zza, (zzv) null);
        zzfk zzr = zza2.zzr();
        zza2.zzu();
    ...
    public final int zza(Intent intent, int i, int i2) {
        ...
        if ("com.google.android.gms.measurement.UPLOAD".equals(action)) {
            zza((Runnable) new zzjy(this, i2, zzr, intent));
        }
        return 2;
    }
    ...
    private final void zza(Runnable runnable) {
        ...
        zza2.zzq().zza((Runnable) new zzka(this, zza2, runnable));
    }
    ...
    public final boolean zza(JobParameters jobParameters) {
        ...
        zza((Runnable) new zzjx(this, zzr, jobParameters));
        return true;
    }
    ...
    private final zzfk zzc() {
        return zzgo.zza((Context) this.zza, (zzv) null).zzr();
    }
