...
final class zzft extends zzhi {
    ...
    public final zzga zzj = new zzga(this, "app_instance_id", (String) null);
    public final zzfy zzk = new zzfy(this, "time_before_start", 10000);
    public final zzfy zzl = new zzfy(this, "session_timeout", 1800000);
    public final zzfv zzm = new zzfv(this, "start_new_session", true);
    public final zzga zzn = new zzga(this, "non_personalized_ads", (String) null);
    ...
    public final zzga zzw = new zzga(this, "firebase_feature_rollouts", (String) null);
    ...
    public final void mo13868f_() {
        ...
        this.zzb = new zzfx(this, "health_monitor", Math.max(0, zzap.zzb.zza(null).longValue()));
    }
