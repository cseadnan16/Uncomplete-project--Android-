...
public final class TypeAdapters {
    ...
    public static final TypeAdapterFactory ENUM_FACTORY = new TypeAdapterFactory() {
        ...
        public <T> com.google.gson.TypeAdapter<T> create(com.google.gson.Gson r3, com.google.gson.reflect.TypeToken<T> r4) {
            ...
            L_0x0021:
                ...
                return r1
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.gson.internal.bind.TypeAdapters.C092530.create(com.google.gson.Gson, com.google.gson.reflect.TypeToken):com.google.gson.TypeAdapter");
        }
    };
    ...
    static {
        ...
        TypeAdapter<BitSet> nullSafe2 = new TypeAdapter<BitSet>() {
            public BitSet read(JsonReader in) throws IOException {
                ...
                while (tokenType != JsonToken.END_ARRAY) {
                    int i2 = C093236.$SwitchMap$com$google$gson$stream$JsonToken[tokenType.ordinal()];
                    boolean set = false;
                    if (i2 != 1) {
                        if (i2 == 2) {
                            set = in.nextBoolean();
        ...
        C090614 r0 = new TypeAdapter<Number>() {
            public Number read(JsonReader in) throws IOException {
                JsonToken jsonToken = in.peek();
                int i = C093236.$SwitchMap$com$google$gson$stream$JsonToken[jsonToken.ordinal()];
                if (i == 1 || i == 3) {
        ...
        C091119 r02 = new TypeAdapter<StringBuilder>() {
        ...
        C091320 r03 = new TypeAdapter<StringBuffer>() {
        ...
        C091421 r04 = new TypeAdapter<URL>() {
        ...
        C091522 r05 = new TypeAdapter<URI>() {
        ...
        C091623 r06 = new TypeAdapter<InetAddress>() {
        ...
        C091724 r07 = new TypeAdapter<UUID>() {
        ...
        C092127 r08 = new TypeAdapter<Calendar>() {
        ...
        C092228 r09 = new TypeAdapter<Locale>() {
        ...
        C092329 r010 = new TypeAdapter<JsonElement>() {
            public JsonElement read(JsonReader in) throws IOException {
                switch (C093236.$SwitchMap$com$google$gson$stream$JsonToken[in.peek().ordinal()]) {
                    case 1:
    ...
    static /* synthetic */ class C093236 {
