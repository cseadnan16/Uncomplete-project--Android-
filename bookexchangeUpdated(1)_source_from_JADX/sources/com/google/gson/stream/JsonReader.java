...
public class JsonReader implements Closeable {
    ...
    private boolean fillBuffer(int minimum) throws IOException {
        ...
        if (i4 != i3) {
            int i5 = i4 - i3;
            this.limit = i5;
            System.arraycopy(buffer2, i3, buffer2, 0, i5);
        } else {
            this.limit = 0;
        }
        this.pos = 0;
        do {
            Reader reader = this.f76in;
            int i6 = this.limit;
            int read = reader.read(buffer2, i6, buffer2.length - i6);
            int total = read;
            if (read == -1) {
                return false;
            }
            ...
            this.limit = i7;
            if (this.lineNumber == 0 && (i = this.lineStart) == 0 && i7 > 0 && buffer2[0] == 65279) {
                this.pos++;
                this.lineStart = i + 1;
                minimum++;
            }
