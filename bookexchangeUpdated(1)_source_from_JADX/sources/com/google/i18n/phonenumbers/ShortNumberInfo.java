...
public class ShortNumberInfo {
    ...
    public ShortNumberCost getExpectedCost(Phonenumber.PhoneNumber number) {
        ...
        for (String regionCode : regionCodes) {
            ...
            int i = C09491.f80xe1b2aad7[costForRegion.ordinal()];
            if (i == 1) {
                return ShortNumberCost.PREMIUM_RATE;
            }
            if (i == 2) {
    ...
    static /* synthetic */ class C09491 {
        ...
        static final /* synthetic */ int[] f80xe1b2aad7;
        ...
        static {
            ...
            try {
                f80xe1b2aad7[ShortNumberCost.UNKNOWN_COST.ordinal()] = 2;
            } catch (NoSuchFieldError e2) {
            }
            try {
                f80xe1b2aad7[ShortNumberCost.STANDARD_RATE.ordinal()] = 3;
            } catch (NoSuchFieldError e3) {
            }
            try {
                f80xe1b2aad7[ShortNumberCost.TOLL_FREE.ordinal()] = 4;
    ...
    public String getExampleShortNumberForCost(String regionCode, ShortNumberCost cost) {
        ...
        int i = C09491.f80xe1b2aad7[cost.ordinal()];
        if (i == 1) {
