...
public class AsYouTypeFormatter {
    ...
    private void getAvailableFormats(String leadingDigits) {
        ...
        for (Phonemetadata.NumberFormat format : formatList) {
            if ((!nationalPrefixIsUsedByCountry || this.isCompleteNumber || format.getNationalPrefixOptionalWhenFormatting() || PhoneNumberUtil.formattingRuleHasFirstGroupOnly(format.getNationalPrefixFormattingRule())) && isFormatEligible(format.getFormat())) {
