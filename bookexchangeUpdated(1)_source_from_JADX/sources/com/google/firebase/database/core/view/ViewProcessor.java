...
public class ViewProcessor {
    ...
    public ProcessorResult applyOperation(ViewCache oldViewCache, Operation operation, WriteTreeRef writesCache, Node optCompleteCache) {
        ...
        int i = C08282.f71xc0d7b136[operation.getType().ordinal()];
        if (i == 1) {
    ...
    static /* synthetic */ class C08282 {
        ...
        static {
            ...
            try {
                f71xc0d7b136[Operation.OperationType.Merge.ordinal()] = 2;
            } catch (NoSuchFieldError e2) {
            }
            try {
                f71xc0d7b136[Operation.OperationType.AckUserWrite.ordinal()] = 3;
            } catch (NoSuchFieldError e3) {
            }
            try {
                f71xc0d7b136[Operation.OperationType.ListenComplete.ordinal()] = 4;
