...
public final class CompoundWrite implements Iterable<Map.Entry<Path, Node>> {
    ...
    private com.google.firebase.database.snapshot.Node applySubtreeWrite(com.google.firebase.database.core.Path r7, com.google.firebase.database.core.utilities.ImmutableTree<com.google.firebase.database.snapshot.Node> r8, com.google.firebase.database.snapshot.Node r9) {
        /*
            r6 = this;
            ...
            com.google.firebase.database.snapshot.Node r0 = r9.updateChild(r7, r0)
            return r0
        L_0x0011:
            r0 = 0
            com.google.firebase.database.collection.ImmutableSortedMap r1 = r8.getChildren()
        ...
        L_0x001a:
            ...
            goto L_0x0049
        L_0x0041:
            com.google.firebase.database.core.Path r5 = r7.child((com.google.firebase.database.snapshot.ChildKey) r4)
            com.google.firebase.database.snapshot.Node r9 = r6.applySubtreeWrite(r5, r3, r9)
        L_0x0049:
            goto L_0x001a
        L_0x004a:
            com.google.firebase.database.snapshot.Node r1 = r9.getChild(r7)
            ...
            com.google.firebase.database.core.Path r1 = r7.child((com.google.firebase.database.snapshot.ChildKey) r1)
            com.google.firebase.database.snapshot.Node r9 = r9.updateChild(r1, r0)
        L_0x0062:
            return r9
        */
