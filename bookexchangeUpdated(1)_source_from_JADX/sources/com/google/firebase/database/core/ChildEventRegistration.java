...
public class ChildEventRegistration extends EventRegistration {
    ...
    public void fireEvent(DataEvent eventData) {
        if (!isZombied()) {
            int i = C07471.f67x916339dc[eventData.getEventType().ordinal()];
            if (i == 1) {
    ...
    static /* synthetic */ class C07471 {
        ...
        static final /* synthetic */ int[] f67x916339dc;
        ...
        static {
            ...
            try {
                f67x916339dc[Event.EventType.CHILD_CHANGED.ordinal()] = 2;
            } catch (NoSuchFieldError e2) {
            }
            try {
                f67x916339dc[Event.EventType.CHILD_MOVED.ordinal()] = 3;
            } catch (NoSuchFieldError e3) {
            }
            try {
                f67x916339dc[Event.EventType.CHILD_REMOVED.ordinal()] = 4;
