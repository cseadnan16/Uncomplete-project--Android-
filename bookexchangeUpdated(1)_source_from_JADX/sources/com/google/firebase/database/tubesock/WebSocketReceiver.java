    ...
    public void run() {
        ...
        while (!this.stop) {
            try {
                ...
                boolean fin = (this.inputHeader[0] & ByteCompanionObject.MIN_VALUE) != 0;
                if (!((this.inputHeader[0] & 112) != 0)) {
                    ...
                    if (length < 126) {
                        ...
                        payload_length = (((long) (this.inputHeader[2] & UByte.MAX_VALUE)) << 8) | ((long) (this.inputHeader[3] & UByte.MAX_VALUE));
