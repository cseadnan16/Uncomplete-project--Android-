...
final class zzaq {
    ...
    public static Map<String, Object> zza(String str) {
        ...
        List<String> zza2 = zzau.zza('.').zza((CharSequence) str);
        if (zza2.size() < 2) {
            Logger logger = zza;
            String valueOf = String.valueOf(str);
            logger.mo11213e(valueOf.length() != 0 ? "Invalid idToken ".concat(valueOf) : new String("Invalid idToken "), new Object[0]);
            return zzbl.zza();
        }
        try {
            Map<String, Object> zzb = zzb(new String(Base64Utils.decodeUrlSafeNoPadding(zza2.get(1)), Key.STRING_CHARSET_NAME));
            return zzb == null ? zzbl.zza() : zzb;
        } catch (UnsupportedEncodingException e) {
            zza.mo11212e("Unable to decode token", e, new Object[0]);
            return zzbl.zza();
        }
    }
