...
public final class zzfo<ResultT, CallbackT> implements zzff<ResultT> {
    ...
    public zzfo(zzfe<ResultT, CallbackT> zzfe, TaskCompletionSource<ResultT> taskCompletionSource) {
        this.zza = zzfe;
    ...
    public final void zza(ResultT resultt, Status status) {
        ...
        if (status == null) {
            ...
            taskCompletionSource.setException(zzeh.zza(instance, zzej, firebaseUser));
