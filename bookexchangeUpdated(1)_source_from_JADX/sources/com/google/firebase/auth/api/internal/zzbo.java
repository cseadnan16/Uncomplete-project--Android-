...
final class zzbo extends zzfe<AuthResult, zza> {
    ...
    public final /* synthetic */ void zza(zzef zzef, TaskCompletionSource taskCompletionSource) throws RemoteException {
        ...
        if (this.zzu) {
            zzef.zza().zza(this.zza.zzb(), this.zza.zzc(), this.zze.zzf(), this.zzc);
        } else {
            zzef.zza().zza(new zzcr(this.zza.zzb(), this.zza.zzc(), this.zze.zzf()), (zzeo) this.zzc);
        }
    }
}
