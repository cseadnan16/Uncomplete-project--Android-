...
public final class zzeh {
    ...
    public static FirebaseAuthMultiFactorException zza(FirebaseAuth firebaseAuth, zzej zzej, FirebaseUser firebaseUser) {
        zzav.zza(firebaseAuth);
        zzav.zza(zzej);
        Pair pair = zza.get(17078);
        return new FirebaseAuthMultiFactorException((String) pair.first, (String) pair.second, zzt.zza(zzej, firebaseAuth, firebaseUser));
    }
