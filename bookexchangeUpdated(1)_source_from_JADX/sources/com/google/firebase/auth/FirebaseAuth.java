...
public class FirebaseAuth implements InternalAuthProvider {
    ...
    /* compiled from: com.google.firebase:firebase-auth@@19.3.0 */
    class zza implements com.google.firebase.auth.internal.zza, zzag {
        zza() {
        }
    ...
    private FirebaseAuth(FirebaseApp firebaseApp, zzau zzau, zzaw zzaw, zzao zzao) {
        zzff zzb2;
        this.zzh = new Object();
        this.zzj = new Object();
        this.zza = (FirebaseApp) Preconditions.checkNotNull(firebaseApp);
        this.zze = (zzau) Preconditions.checkNotNull(zzau);
        this.zzl = (zzaw) Preconditions.checkNotNull(zzaw);
        this.zzg = new zzo();
        this.zzm = (zzao) Preconditions.checkNotNull(zzao);
    ...
    public final void zza() {
        ...
        if (firebaseUser != null) {
            zzaw zzaw = this.zzl;
            Preconditions.checkNotNull(firebaseUser);
            zzaw.zza(String.format("com.google.firebase.auth.GET_TOKEN_RESPONSE.%s", new Object[]{firebaseUser.getUid()}));
            this.zzf = null;
        }
    ...
    private final synchronized void zza(zzaz zzaz) {
        this.zzn = zzaz;
    }
    ...
    /* JADX WARNING: type inference failed for: r2v0, types: [com.google.firebase.auth.zzk, com.google.firebase.auth.internal.zzba] */
    public final Task<GetTokenResult> zza(FirebaseUser firebaseUser, boolean z) {
        ...
        if (!zze2.zzb() || z) {
            return this.zze.zza(this.zza, firebaseUser, zze2.zzc(), (zzba) new zzk(this));
        }
        return Tasks.forResult(zzar.zza(zze2.zzd()));
    }
    ...
    public Task<AuthResult> signInWithCredential(AuthCredential authCredential) {
        ...
        if (zza2 instanceof EmailAuthCredential) {
            ...
            if (!emailAuthCredential.zzg()) {
                return this.zze.zzb(this.zza, emailAuthCredential.zzb(), emailAuthCredential.zzc(), this.zzk, (com.google.firebase.auth.internal.zza) new zzb());
            }
            if (zzb(emailAuthCredential.zzd())) {
                return Tasks.forException(zzeh.zza(new Status(17072)));
            }
            return this.zze.zza(this.zza, emailAuthCredential, (com.google.firebase.auth.internal.zza) new zzb());
        } else if (!(zza2 instanceof PhoneAuthCredential)) {
            return this.zze.zza(this.zza, zza2, this.zzk, (com.google.firebase.auth.internal.zza) new zzb());
        } else {
            return this.zze.zza(this.zza, (PhoneAuthCredential) zza2, this.zzk, (com.google.firebase.auth.internal.zza) new zzb());
        }
    }

    /* JADX WARNING: type inference failed for: r5v0, types: [com.google.firebase.auth.internal.zzba, com.google.firebase.auth.FirebaseAuth$zza] */
    /* JADX WARNING: type inference failed for: r9v0, types: [com.google.firebase.auth.internal.zzba, com.google.firebase.auth.FirebaseAuth$zza] */
    /* JADX WARNING: type inference failed for: r1v1, types: [com.google.firebase.auth.internal.zzba, com.google.firebase.auth.FirebaseAuth$zza] */
    /* JADX WARNING: type inference failed for: r10v0, types: [com.google.firebase.auth.internal.zzba, com.google.firebase.auth.FirebaseAuth$zza] */
    ...
    public Task<AuthResult> signInWithCustomToken(String str) {
        ...
        return this.zze.zza(this.zza, str, this.zzk, (com.google.firebase.auth.internal.zza) new zzb());
    }

    public Task<AuthResult> signInWithEmailAndPassword(String str, String str2) {
        Preconditions.checkNotEmpty(str);
        Preconditions.checkNotEmpty(str2);
        return this.zze.zzb(this.zza, str, str2, this.zzk, (com.google.firebase.auth.internal.zza) new zzb());
    }
    ...
    public Task<AuthResult> signInAnonymously() {
        ...
        if (firebaseUser == null || !firebaseUser.isAnonymous()) {
            return this.zze.zza(this.zza, (com.google.firebase.auth.internal.zza) new zzb(), this.zzk);
        }
    ...
    public static void zza(PhoneAuthOptions phoneAuthOptions) {
        if (phoneAuthOptions.zzl()) {
            ...
            zzy zzy = (zzy) phoneAuthOptions.zzg();
            if (zzy.zzc()) {
                zza2.zze.zza(zzy, phoneAuthOptions.zzb(), zza2.zzi, longValue, phoneAuthOptions.zzf() != null, phoneAuthOptions.zzi(), zza3, phoneAuthOptions.zze(), phoneAuthOptions.zzj());
            } else {
                zza2.zze.zza(zzy, phoneAuthOptions.zzk(), zza2.zzi, longValue, phoneAuthOptions.zzf() != null, phoneAuthOptions.zzi(), zza3, phoneAuthOptions.zze(), phoneAuthOptions.zzj());
            }
        } else {
    ...
    /* JADX WARNING: type inference failed for: r0v7, types: [com.google.firebase.auth.internal.zzba, com.google.firebase.auth.FirebaseAuth$zzc] */
    ...
    /* JADX WARNING: type inference failed for: r0v0, types: [com.google.firebase.auth.internal.zzba, com.google.firebase.auth.FirebaseAuth$zza] */
    public final Task<Void> zza(FirebaseUser firebaseUser) {
        return zza(firebaseUser, (zzba) new zza());
    }

    private final Task<Void> zza(FirebaseUser firebaseUser, zzba zzba) {
        Preconditions.checkNotNull(firebaseUser);
        return this.zze.zza(this.zza, firebaseUser, zzba);
    }

    /* JADX WARNING: type inference failed for: r2v0, types: [com.google.firebase.auth.internal.zzba, com.google.firebase.auth.FirebaseAuth$zza] */
    ...
    public Task<AuthResult> createUserWithEmailAndPassword(String str, String str2) {
        Preconditions.checkNotEmpty(str);
        Preconditions.checkNotEmpty(str2);
        return this.zze.zza(this.zza, str, str2, this.zzk, (com.google.firebase.auth.internal.zza) new zzb());
    }
    ...
    public final Task<AuthResult> zza(MultiFactorAssertion multiFactorAssertion, zzy zzy, FirebaseUser firebaseUser) {
        Preconditions.checkNotNull(multiFactorAssertion);
        Preconditions.checkNotNull(zzy);
        return this.zze.zza(this.zza, firebaseUser, (PhoneMultiFactorAssertion) multiFactorAssertion, zzy.zzb(), (com.google.firebase.auth.internal.zza) new zzb());
    }
    ...
    public final Task<Void> zzb(FirebaseUser firebaseUser) {
        Preconditions.checkNotNull(firebaseUser);
        return this.zze.zza(firebaseUser, (zzad) new zzo(this, firebaseUser));
    }
    ...
    public final Task<Void> zza(FirebaseUser firebaseUser, MultiFactorAssertion multiFactorAssertion, String str) {
        ...
        return this.zze.zza(this.zza, (PhoneMultiFactorAssertion) multiFactorAssertion, firebaseUser, str, (com.google.firebase.auth.internal.zza) new zzb());
    }
