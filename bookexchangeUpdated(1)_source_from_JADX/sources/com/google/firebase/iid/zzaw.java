...
public final class zzaw {
    ...
    public static android.content.ComponentName zza(android.content.Context r4, android.content.Intent r5) {
        /*
            ...
            monitor-enter(r0)
            com.google.android.gms.stats.WakeLock r1 = zzc     // Catch:{ all -> 0x0036 }
            r2 = 1
            if (r1 != 0) goto L_0x0016
            com.google.android.gms.stats.WakeLock r1 = new com.google.android.gms.stats.WakeLock     // Catch:{ all -> 0x0036 }
            java.lang.String r3 = "wake:com.google.firebase.iid.WakeLockHolder"
            r1.<init>(r4, r2, r3)     // Catch:{ all -> 0x0036 }
            zzc = r1     // Catch:{ all -> 0x0036 }
            r1.setReferenceCounted(r2)     // Catch:{ all -> 0x0036 }
        L_0x0016:
            ...
            zza((android.content.Intent) r5, (boolean) r2)     // Catch:{ all -> 0x0036 }
        ...
        L_0x002b:
            ...
            com.google.android.gms.stats.WakeLock r5 = zzc     // Catch:{ all -> 0x0036 }
            long r1 = zza     // Catch:{ all -> 0x0036 }
            r5.acquire(r1)     // Catch:{ all -> 0x0036 }
        L_0x0034:
            monitor-exit(r0)     // Catch:{ all -> 0x0036 }
            return r4
        L_0x0036:
