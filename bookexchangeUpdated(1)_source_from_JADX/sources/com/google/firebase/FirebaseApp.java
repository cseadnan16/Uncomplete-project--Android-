...
public class FirebaseApp {
    ...
    protected FirebaseApp(Context applicationContext2, String name2, FirebaseOptions options2) {
        ...
        componentArr[0] = Component.m72of(applicationContext2, Context.class, new Class[0]);
        componentArr[1] = Component.m72of(this, FirebaseApp.class, new Class[0]);
        componentArr[2] = Component.m72of(options2, FirebaseOptions.class, new Class[0]);
