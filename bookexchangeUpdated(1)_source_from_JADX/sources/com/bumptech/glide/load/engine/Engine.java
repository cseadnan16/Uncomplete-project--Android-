...
public class Engine implements EngineJobListener, MemoryCache.ResourceRemovedListener, EngineResource.ResourceListener {
    ...
    public <R> LoadStatus load(GlideContext glideContext, Object model, Key signature, int width, int height, Class<?> resourceClass, Class<R> transcodeClass, Priority priority, DiskCacheStrategy diskCacheStrategy, Map<Class<?>, Transformation<?>> transformations, boolean isTransformationRequired, boolean isScaleOnlyOrNoTransform, Options options, boolean isMemoryCacheable, boolean useUnlimitedSourceExecutorPool, boolean useAnimationPool, boolean onlyRetrieveFromCache, ResourceCallback cb) {
        ...
        EngineJob<?> engineJob = current;
        EngineJob<R> engineJob2 = this.engineJobFactory.build(key, isMemoryCacheable, useUnlimitedSourceExecutorPool, useAnimationPool, onlyRetrieveFromCache);
        EngineResource<?> engineResource = cached;
        DecodeJobFactory decodeJobFactory2 = this.decodeJobFactory;
        String str = TAG;
        EngineResource<?> engineResource2 = active;
        DecodeJob<R> decodeJob = decodeJobFactory2.build(glideContext, model, key, signature, width, height, resourceClass, transcodeClass, priority, diskCacheStrategy, transformations, isTransformationRequired, isScaleOnlyOrNoTransform, onlyRetrieveFromCache, options, engineJob2);
        this.jobs.put(key, engineJob2);
    ...
    public static class LoadStatus {
        ...
        /* renamed from: cb */
        private final ResourceCallback f49cb;
        ...
        public void cancel() {
            this.engineJob.removeCallback(this.f49cb);
        }
    }
