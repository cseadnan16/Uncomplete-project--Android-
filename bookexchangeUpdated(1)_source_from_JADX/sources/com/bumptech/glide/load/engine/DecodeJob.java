...
class DecodeJob<R> implements DataFetcherGenerator.FetcherReadyCallback, Runnable, Comparable<DecodeJob<?>>, FactoryPools.Poolable {
    ...
    public void run() {
        ...
        L_0x0015:
            ...
            return
        L_0x0019:
            r5.runWrapped()     // Catch:{ all -> 0x0025 }
        ...
        L_0x0025:
            r2 = move-exception
            r3 = 3
            boolean r3 = android.util.Log.isLoggable(r0, r3)     // Catch:{ all -> 0x0065 }
            ...
            boolean r4 = r5.isCancelled     // Catch:{ all -> 0x0065 }
            r3.append(r4)     // Catch:{ all -> 0x0065 }
            java.lang.String r4 = ", stage: "
            r3.append(r4)     // Catch:{ all -> 0x0065 }
            com.bumptech.glide.load.engine.DecodeJob$Stage r4 = r5.stage     // Catch:{ all -> 0x0065 }
            r3.append(r4)     // Catch:{ all -> 0x0065 }
            java.lang.String r3 = r3.toString()     // Catch:{ all -> 0x0065 }
            android.util.Log.d(r0, r3, r2)     // Catch:{ all -> 0x0065 }
        L_0x004d:
            com.bumptech.glide.load.engine.DecodeJob$Stage r0 = r5.stage     // Catch:{ all -> 0x0065 }
            com.bumptech.glide.load.engine.DecodeJob$Stage r3 = com.bumptech.glide.load.engine.DecodeJob.Stage.ENCODE     // Catch:{ all -> 0x0065 }
            if (r0 == r3) goto L_0x005b
            java.util.List<java.lang.Throwable> r0 = r5.throwables     // Catch:{ all -> 0x0065 }
            r0.add(r2)     // Catch:{ all -> 0x0065 }
            r5.notifyFailed()     // Catch:{ all -> 0x0065 }
        L_0x005b:
            boolean r0 = r5.isCancelled     // Catch:{ all -> 0x0065 }
    ...
    private void runWrapped() {
        int i = C04561.$SwitchMap$com$bumptech$glide$load$engine$DecodeJob$RunReason[this.runReason.ordinal()];
        if (i == 1) {
    ...
    private DataFetcherGenerator getNextGenerator() {
        int i = C04561.$SwitchMap$com$bumptech$glide$load$engine$DecodeJob$Stage[this.stage.ordinal()];
        if (i == 1) {
    ...
    private Stage getNextStage(Stage current) {
        int i = C04561.$SwitchMap$com$bumptech$glide$load$engine$DecodeJob$Stage[current.ordinal()];
        if (i == 1) {
    ...
    public <Z> Resource<Z> onResourceDecoded(DataSource dataSource, Resource<Z> decoded) {
        ...
        if (!this.diskCacheStrategy.isResourceCacheable(isFromAlternateCacheKey, dataSource2, encodeStrategy)) {
            ...
            int i = C04561.$SwitchMap$com$bumptech$glide$load$EncodeStrategy[encodeStrategy.ordinal()];
            if (i == 1) {
