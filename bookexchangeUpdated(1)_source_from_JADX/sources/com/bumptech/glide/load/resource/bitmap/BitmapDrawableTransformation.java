...
public class BitmapDrawableTransformation implements Transformation<BitmapDrawable> {
    ...
    @Deprecated
    public BitmapDrawableTransformation(Context context, Transformation<Bitmap> wrapped2) {
        this(wrapped2);
    }

    @Deprecated
    public BitmapDrawableTransformation(Context context, BitmapPool bitmapPool, Transformation<Bitmap> wrapped2) {
        this(wrapped2);
    }
