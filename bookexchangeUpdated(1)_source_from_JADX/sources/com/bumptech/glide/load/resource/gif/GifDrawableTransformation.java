...
public class GifDrawableTransformation implements Transformation<GifDrawable> {
    ...
    @Deprecated
    public GifDrawableTransformation(Context context, Transformation<Bitmap> wrapped2) {
        this(wrapped2);
    }

    @Deprecated
    public GifDrawableTransformation(Transformation<Bitmap> wrapped2, BitmapPool bitmapPool) {
        this(wrapped2);
    }
