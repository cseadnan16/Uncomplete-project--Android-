...
public class RequestManagerRetriever implements Handler.Callback {
    ...
    private final ArrayMap<View, C0198Fragment> tempViewToSupportFragment = new ArrayMap<>();
    ...
    public RequestManager get(FragmentActivity activity) {
        ...
        return supportFragmentGet(activity, activity.getSupportFragmentManager(), (C0198Fragment) null);
    }

    public RequestManager get(C0198Fragment fragment) {
    ...
    public RequestManager get(View view) {
        ...
        if (activity instanceof FragmentActivity) {
            C0198Fragment fragment = findSupportFragment(view, (FragmentActivity) activity);
    ...
    private static void findAllSupportFragmentsWithViews(Collection<C0198Fragment> topLevelFragments, Map<View, C0198Fragment> result) {
        if (topLevelFragments != null) {
            for (C0198Fragment fragment : topLevelFragments) {
    ...
    private androidx.fragment.app.C0198Fragment findSupportFragment(android.view.View r5, androidx.fragment.app.FragmentActivity r6) {
        /*
            r4 = this;
        ...
        L_0x001c:
            ...
            r0 = r3
            androidx.fragment.app.Fragment r0 = (androidx.fragment.app.C0198Fragment) r0
    ...
    public RequestManagerFragment getRequestManagerFragment(FragmentManager fm, Fragment parentHint) {
    ...
    /* access modifiers changed from: package-private */
    public SupportRequestManagerFragment getSupportRequestManagerFragment(androidx.fragment.app.FragmentManager fm, C0198Fragment parentHint) {
        ...
        fm.beginTransaction().add((C0198Fragment) current3, FRAGMENT_TAG).commitAllowingStateLoss();
        this.handler.obtainMessage(2, fm).sendToTarget();
        return current3;
    }

    private RequestManager supportFragmentGet(Context context, androidx.fragment.app.FragmentManager fm, C0198Fragment parentHint) {
