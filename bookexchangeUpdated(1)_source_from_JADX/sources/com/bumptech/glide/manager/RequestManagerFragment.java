...
public class RequestManagerFragment extends Fragment {
    ...
    private void registerFragmentWithRoot(Activity activity) {
        ...
        RequestManagerFragment requestManagerFragment = Glide.get(activity).getRequestManagerRetriever().getRequestManagerFragment(activity.getFragmentManager(), (Fragment) null);
