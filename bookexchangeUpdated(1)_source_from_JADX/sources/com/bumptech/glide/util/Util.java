...
import com.bumptech.glide.load.model.C0483Model;
...
public final class Util {
    ...
    private static int getBytesPerPixel(Bitmap.Config config) {
        ...
        int i = C04941.$SwitchMap$android$graphics$Bitmap$Config[config.ordinal()];
        if (i == 1) {
            return 1;
        }
        if (i == 2 || i == 3) {
    ...
    public static boolean bothModelsNullEquivalentOrEquals(Object a, Object b) {
        ...
        if (a instanceof C0483Model) {
            return ((C0483Model) a).isEquivalentTo(b);
        }
        return a.equals(b);
    }
