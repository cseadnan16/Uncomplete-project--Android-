...
public class GifHeaderParser {
    ...
    private void readBitmap() {
        this.header.currentFrame.f45ix = readShort();
        this.header.currentFrame.f46iy = readShort();
        this.header.currentFrame.f44iw = readShort();
        this.header.currentFrame.f43ih = readShort();
        int packed = read();
        boolean z = false;
