...
public class Glide implements ComponentCallbacks2 {
    ...
    Glide(Context context, Engine engine2, MemoryCache memoryCache2, BitmapPool bitmapPool2, ArrayPool arrayPool2, RequestManagerRetriever requestManagerRetriever2, ConnectivityMonitorFactory connectivityMonitorFactory2, int logLevel, RequestOptions defaultRequestOptions, Map<Class<?>, TransitionOptions<?, ?>> defaultTransitionOptions) {
        ...
        GlideContext glideContext3 = new GlideContext(context, arrayPool2, this.registry, imageViewTargetFactory, defaultRequestOptions, defaultTransitionOptions, engine2, logLevel);
    ...
    public static RequestManager with(C0198Fragment fragment) {
        return getRetriever(fragment.getActivity()).get(fragment);
    }
