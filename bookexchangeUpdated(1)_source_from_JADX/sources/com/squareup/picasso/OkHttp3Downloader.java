...
public final class OkHttp3Downloader implements Downloader {
    ...
    public OkHttp3Downloader(Context context) {
        this(C0967Utils.createDefaultCacheDir(context));
    }

    public OkHttp3Downloader(File cacheDir) {
        this(cacheDir, C0967Utils.calculateDiskCacheSize(cacheDir));
    }

    public OkHttp3Downloader(Context context, long maxSize) {
        this(C0967Utils.createDefaultCacheDir(context), maxSize);
    }
