...
class ResourceRequestHandler extends RequestHandler {
    ...
    public RequestHandler.Result load(Request request, int networkPolicy) throws IOException {
        Resources res = C0967Utils.getResources(this.context, request);
        return new RequestHandler.Result(decodeResource(res, C0967Utils.getResourceId(res, request), request), Picasso.LoadedFrom.DISK);
    }
