...
class FragmentAnim {
    ...
    static AnimationOrAnimator loadAnimation(Context context, FragmentContainer fragmentContainer, C0198Fragment fragment, boolean enter) {
        int animResourceId;
        int transit = fragment.getNextTransition();
        int nextAnim = fragment.getNextAnim();
        fragment.setNextAnim(0);
        View container = fragmentContainer.onFindViewById(fragment.mContainerId);
        if (!(container == null || container.getTag(C1024R.C1027id.visible_removing_fragment_view_tag) == null)) {
            container.setTag(C1024R.C1027id.visible_removing_fragment_view_tag, (Object) null);
        }
    ...
    static void animateRemoveFragment(final C0198Fragment fragment, AnimationOrAnimator anim, final FragmentTransition.Callback callback) {
        ...
        final C0198Fragment fragment2 = fragment;
    ...
    private static int transitToAnimResourceId(int transit, boolean enter) {
        if (transit == 4097) {
            return enter ? C1024R.anim.fragment_open_enter : C1024R.anim.fragment_open_exit;
        } else if (transit == 4099) {
            return enter ? C1024R.anim.fragment_fade_enter : C1024R.anim.fragment_fade_exit;
        } else if (transit != 8194) {
            return -1;
        } else {
            return enter ? C1024R.anim.fragment_close_enter : C1024R.anim.fragment_close_exit;
        }
    }
