...
public class FragmentActivity extends ComponentActivity implements ActivityCompat.OnRequestPermissionsResultCallback, ActivityCompat.RequestPermissionsRequestCodeValidator {
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestIndex != 0) {
            ...
            C0198Fragment targetFragment = this.mFragments.findFragmentByWho(who);
    ...
    public void onCreate(Bundle savedInstanceState) {
        this.mFragments.attachHost((C0198Fragment) null);
    ...
    public void onAttachFragment(C0198Fragment fragment) {
    }
    ...
    public void onRequestPermissionsResult(int requestCode, String[] permissions, int[] grantResults) {
        ...
        if (index != 0) {
            ...
            C0198Fragment frag = this.mFragments.findFragmentByWho(who);
            if (frag == null) {
                Log.w(TAG, "Activity result no fragment exists for who: " + who);
                return;
            }
    ...
    public void startActivityFromFragment(C0198Fragment fragment, Intent intent, int requestCode) {
        startActivityFromFragment(fragment, intent, requestCode, (Bundle) null);
    }

    public void startActivityFromFragment(C0198Fragment fragment, Intent intent, int requestCode, Bundle options) {
    ...
    public void startIntentSenderFromFragment(C0198Fragment fragment, IntentSender intent, int requestCode, Intent fillInIntent, int flagsMask, int flagsValues, int extraFlags, Bundle options) throws IntentSender.SendIntentException {
        int i = requestCode;
    ...
    private int allocateRequestIndex(C0198Fragment fragment) {
    ...
    /* access modifiers changed from: package-private */
    public void requestPermissionsFromFragment(C0198Fragment fragment, String[] permissions, int requestCode) {
        if (requestCode == -1) {
    ...
    class HostCallbacks extends FragmentHostCallback<FragmentActivity> implements ViewModelStoreOwner, OnBackPressedDispatcherOwner {
        ...
        public boolean onShouldSaveFragmentState(C0198Fragment fragment) {
        ...
        public void onStartActivityFromFragment(C0198Fragment fragment, Intent intent, int requestCode) {
            FragmentActivity.this.startActivityFromFragment(fragment, intent, requestCode);
        }

        public void onStartActivityFromFragment(C0198Fragment fragment, Intent intent, int requestCode, Bundle options) {
            FragmentActivity.this.startActivityFromFragment(fragment, intent, requestCode, options);
        }

        public void onStartIntentSenderFromFragment(C0198Fragment fragment, IntentSender intent, int requestCode, Intent fillInIntent, int flagsMask, int flagsValues, int extraFlags, Bundle options) throws IntentSender.SendIntentException {
        ...
        public void onRequestPermissionsFromFragment(C0198Fragment fragment, String[] permissions, int requestCode) {
    ...
    private static boolean markState(FragmentManager manager, Lifecycle.State state) {
        ...
        for (C0198Fragment fragment : manager.getFragments()) {
            if (fragment != null) {
