...
class FragmentLayoutInflaterFactory implements LayoutInflater.Factory2 {
    ...
    public View onCreateView(View parent, String name, Context context, AttributeSet attrs) {
        ...
        C0198Fragment fragment = null;
        if (!"fragment".equals(name)) {
            return null;
        }
        String fname = attrs.getAttributeValue((String) null, "class");
        TypedArray a = context.obtainStyledAttributes(attrs, C1024R.styleable.Fragment);
        if (fname == null) {
            fname = a.getString(C1024R.styleable.Fragment_android_name);
        }
        int id = a.getResourceId(C1024R.styleable.Fragment_android_id, -1);
        String tag = a.getString(C1024R.styleable.Fragment_android_tag);
        a.recycle();
