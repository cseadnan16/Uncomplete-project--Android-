...
public class FragmentController {
    ...
    public List<C0198Fragment> getActiveFragments(List<C0198Fragment> list) {
        return this.mHost.mFragmentManager.getActiveFragments();
    }

    public void attachHost(C0198Fragment parent) {
    ...
    @Deprecated
    public void restoreAllState(Parcelable state, List<C0198Fragment> nonConfigList) {
    ...
    @Deprecated
    public List<C0198Fragment> retainNonConfig() {
