...
class FragmentTransition {
    ...
    interface Callback {
        void onComplete(C0198Fragment fragment, CancellationSignal cancellationSignal);

        void onStart(C0198Fragment fragment, CancellationSignal cancellationSignal);
    }
    ...
    private static void replaceHide(FragmentTransitionImpl impl, Object exitTransition, C0198Fragment exitingFragment, final ArrayList<View> exitingViews) {
    ...
    private static void scheduleTargetChange(FragmentTransitionImpl impl, ViewGroup sceneRoot, C0198Fragment inFragment, View nonExistentView, ArrayList<View> sharedElementsIn, Object enterTransition, ArrayList<View> enteringViews, Object exitTransition, ArrayList<View> exitingViews) {
        final Object obj = enterTransition;
        final FragmentTransitionImpl fragmentTransitionImpl = impl;
        final View view = nonExistentView;
        final C0198Fragment fragment = inFragment;
    ...
    private static FragmentTransitionImpl chooseImpl(C0198Fragment outFragment, C0198Fragment inFragment) {
    ...
    private static Object getSharedElementTransition(FragmentTransitionImpl impl, C0198Fragment inFragment, C0198Fragment outFragment, boolean isPop) {
        Object obj;
    ...
    private static Object getEnterTransition(FragmentTransitionImpl impl, C0198Fragment inFragment, boolean isPop) {
        Object obj;
        if (inFragment == null) {
            return null;
        }
    ...
    private static Object getExitTransition(FragmentTransitionImpl impl, C0198Fragment outFragment, boolean isPop) {
        Object obj;
        if (outFragment == null) {
            return null;
        }
    ...
    private static Object configureSharedElementsReordered(FragmentTransitionImpl impl, ViewGroup sceneRoot, View nonExistentView, ArrayMap<String, String> nameOverrides, FragmentContainerTransition fragments, ArrayList<View> sharedElementsOut, ArrayList<View> sharedElementsIn, Object enterTransition, Object exitTransition) {
        ...
        C0198Fragment inFragment = fragmentContainerTransition.lastIn;
        C0198Fragment outFragment = fragmentContainerTransition.firstOut;
        if (inFragment != null) {
            inFragment.requireView().setVisibility(0);
        }
        if (inFragment == null) {
            ViewGroup viewGroup = sceneRoot;
            C0198Fragment fragment = outFragment;
        } else if (outFragment == null) {
            ViewGroup viewGroup2 = sceneRoot;
            C0198Fragment fragment2 = outFragment;
        } else {
            ...
            final C0198Fragment fragment3 = inFragment;
            final C0198Fragment fragment4 = outFragment;
            ...
            C0198Fragment fragment5 = outFragment;
            final Rect rect = epicenter;
            C02235 r0 = new Runnable() {
                public void run() {
    ...
    private static Object configureSharedElementsOrdered(FragmentTransitionImpl impl, ViewGroup sceneRoot, View nonExistentView, ArrayMap<String, String> nameOverrides, FragmentContainerTransition fragments, ArrayList<View> sharedElementsOut, ArrayList<View> sharedElementsIn, Object enterTransition, Object exitTransition) {
        ...
        if (inFragment == null) {
            ViewGroup viewGroup = sceneRoot;
            C0198Fragment fragment = outFragment;
            C0198Fragment fragment2 = inFragment;
        } else if (outFragment == null) {
            ViewGroup viewGroup2 = sceneRoot;
            C0198Fragment fragment3 = outFragment;
            C0198Fragment fragment4 = inFragment;
        } else {
            ...
            final View view = nonExistentView;
            C02246 r13 = r0;
            final C0198Fragment fragment5 = inFragment;
            final C0198Fragment fragment6 = outFragment;
            boolean z = inIsPop;
            C0198Fragment fragment7 = outFragment;
            final ArrayList<View> arrayList3 = sharedElementsOut;
            C0198Fragment fragment8 = inFragment;
            final Object obj2 = enterTransition;
            final Rect rect = inEpicenter;
            C02246 r0 = new Runnable() {
                public void run() {
    ...
    private static ArrayMap<String, View> captureOutSharedElements(FragmentTransitionImpl impl, ArrayMap<String, String> nameOverrides, Object sharedElementTransition, FragmentContainerTransition fragments) {
        ...
        C0198Fragment outFragment = fragments.firstOut;
    ...
    static ArrayMap<String, View> captureInSharedElements(FragmentTransitionImpl impl, ArrayMap<String, String> nameOverrides, Object sharedElementTransition, FragmentContainerTransition fragments) {
        ...
        SharedElementCallback sharedElementCallback;
        String key;
        C0198Fragment inFragment = fragments.lastIn;
    ...
    static void callSharedElementStartEnd(C0198Fragment inFragment, C0198Fragment outFragment, boolean isPop, ArrayMap<String, View> sharedElements, boolean isStart) {
        SharedElementCallback sharedElementCallback;
        if (isPop) {
            sharedElementCallback = outFragment.getEnterTransitionCallback();
        } else {
    ...
    static ArrayList<View> configureEnteringExitingViews(FragmentTransitionImpl impl, Object transition, C0198Fragment fragment, ArrayList<View> sharedElements, View nonExistentView) {
    ...
    private static Object mergeTransitions(FragmentTransitionImpl impl, Object enterTransition, Object exitTransition, Object sharedElementTransition, C0198Fragment inFragment, boolean isPop) {
        boolean z;
    ...
    public static void calculateFragments(BackStackRecord transaction, SparseArray<FragmentContainerTransition> transitioningFragments, boolean isReordered) {
        ...
        for (int opNum = 0; opNum < numOps; opNum++) {
            addToFirstInLastOut(transaction, (FragmentTransaction.C0218Op) transaction.mOps.get(opNum), transitioningFragments, false, isReordered);
        }
    }
    ...
    public static void calculatePopFragments(BackStackRecord transaction, SparseArray<FragmentContainerTransition> transitioningFragments, boolean isReordered) {
        if (transaction.mManager.mContainer.onHasView()) {
            for (int opNum = transaction.mOps.size() - 1; opNum >= 0; opNum--) {
                addToFirstInLastOut(transaction, (FragmentTransaction.C0218Op) transaction.mOps.get(opNum), transitioningFragments, true, isReordered);
            }
        }
    }
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private static void addToFirstInLastOut(androidx.fragment.app.BackStackRecord r16, androidx.fragment.app.FragmentTransaction.C0218Op r17, android.util.SparseArray<androidx.fragment.app.FragmentTransition.FragmentContainerTransition> r18, boolean r19, boolean r20) {
        /*
            r0 = r16
            r1 = r17
            r2 = r18
        ...
        L_0x00c4:
            ...
            r14.makeActive(r4)
            r14.moveToState((androidx.fragment.app.C0198Fragment) r4, (int) r12)
        L_0x00d8:
    ...
    static class FragmentContainerTransition {
        public C0198Fragment firstOut;
        public boolean firstOutIsPop;
        public BackStackRecord firstOutTransaction;
        public C0198Fragment lastIn;
