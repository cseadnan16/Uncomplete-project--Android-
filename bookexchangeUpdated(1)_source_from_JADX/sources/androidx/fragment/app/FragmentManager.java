...
public abstract class FragmentManager {
    ...
    private ArrayList<C0198Fragment> mCreatedMenus;
    int mCurState = -1;
    ...
    private ConcurrentHashMap<C0198Fragment, HashSet<CancellationSignal>> mExitAnimationCancellationSignals = new ConcurrentHashMap<>();
    ...
    private final FragmentTransition.Callback mFragmentTransitionCallback = new FragmentTransition.Callback() {
        public void onStart(C0198Fragment fragment, CancellationSignal signal) {
            FragmentManager.this.addCancellationSignal(fragment, signal);
        }

        public void onComplete(C0198Fragment f, CancellationSignal signal) {
    ...
    private C0198Fragment mParent;
    private final ArrayList<OpGenerator> mPendingActions = new ArrayList<>();
    private ArrayList<StartEnterTransitionListener> mPostponedTransactions;
    C0198Fragment mPrimaryNav;
    private boolean mStateSaved;
    private boolean mStopped;
    private ArrayList<C0198Fragment> mTmpAddedFragments;
    ...
    public static abstract class FragmentLifecycleCallbacks {
        public void onFragmentPreAttached(FragmentManager fm, C0198Fragment f, Context context) {
        }

        public void onFragmentAttached(FragmentManager fm, C0198Fragment f, Context context) {
        }

        public void onFragmentPreCreated(FragmentManager fm, C0198Fragment f, Bundle savedInstanceState) {
        }

        public void onFragmentCreated(FragmentManager fm, C0198Fragment f, Bundle savedInstanceState) {
        }

        public void onFragmentActivityCreated(FragmentManager fm, C0198Fragment f, Bundle savedInstanceState) {
        }

        public void onFragmentViewCreated(FragmentManager fm, C0198Fragment f, View v, Bundle savedInstanceState) {
        }

        public void onFragmentStarted(FragmentManager fm, C0198Fragment f) {
        }

        public void onFragmentResumed(FragmentManager fm, C0198Fragment f) {
        }

        public void onFragmentPaused(FragmentManager fm, C0198Fragment f) {
        }

        public void onFragmentStopped(FragmentManager fm, C0198Fragment f) {
        }

        public void onFragmentSaveInstanceState(FragmentManager fm, C0198Fragment f, Bundle outState) {
        }

        public void onFragmentViewDestroyed(FragmentManager fm, C0198Fragment f) {
        }

        public void onFragmentDestroyed(FragmentManager fm, C0198Fragment f) {
        }

        public void onFragmentDetached(FragmentManager fm, C0198Fragment f) {
        }
    }
    ...
    public boolean isPrimaryNavigation(C0198Fragment parent) {
        if (parent == null) {
            return true;
        }
    ...
    private boolean popBackStackImmediate(String name, int id, int flags) {
        ...
        C0198Fragment fragment = this.mPrimaryNav;
    ...
    /* access modifiers changed from: package-private */
    public void addCancellationSignal(C0198Fragment f, CancellationSignal signal) {
    ...
    /* access modifiers changed from: package-private */
    public void removeCancellationSignal(C0198Fragment f, CancellationSignal signal) {
    ...
    public void putFragment(Bundle bundle, String key, C0198Fragment fragment) {
    ...
    public C0198Fragment getFragment(Bundle bundle, String key) {
    ...
    public static <F extends C0198Fragment> F findFragment(View view) {
        C0198Fragment fragment = findViewFragment(view);
        if (fragment != null) {
            return fragment;
        }
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private static androidx.fragment.app.C0198Fragment findViewFragment(android.view.View r4) {
        /*
        L_0x0000:
            r0 = 0
    ...
    static C0198Fragment getViewFragment(View view) {
        Object tag = view.getTag(C1024R.C1027id.fragment_container_view_tag);
        if (tag instanceof C0198Fragment) {
            return (C0198Fragment) tag;
        }
        return null;
    }
    ...
    private FragmentManagerViewModel getChildNonConfig(C0198Fragment f) {
        return this.mNonConfig.getChildNonConfig(f);
    }

    /* access modifiers changed from: package-private */
    public void addRetainedFragment(C0198Fragment f) {
        if (isStateSaved()) {
    ...
    /* access modifiers changed from: package-private */
    public void removeRetainedFragment(C0198Fragment f) {
        if (isStateSaved()) {
            if (isLoggingEnabled(2)) {
    ...
    public C0198Fragment.SavedState saveFragmentInstanceState(C0198Fragment fragment) {
    ...
    public String toString() {
        ...
        sb.append(" in ");
        C0198Fragment fragment = this.mParent;
        if (fragment != null) {
    ...
    public void dump(String prefix, FileDescriptor fd, PrintWriter writer, String[] args) {
        ...
        ArrayList<C0198Fragment> arrayList = this.mCreatedMenus;
    ...
    /* access modifiers changed from: package-private */
    public void performPendingDeferredStart(C0198Fragment f) {
        if (!f.mDeferStart) {
            return;
        }
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public void moveToState(androidx.fragment.app.C0198Fragment r12, int r13) {
        /*
            r11 = this;
        ...
        L_0x0060:
            ...
            androidx.fragment.app.Fragment r2 = r12.mTarget
            r11.moveToState((androidx.fragment.app.C0198Fragment) r2, (int) r1)
        L_0x0085:
            androidx.fragment.app.Fragment r2 = r12.mTarget
    ...
    private void cancelExitAnimation(C0198Fragment f) {
        HashSet<CancellationSignal> signals = this.mExitAnimationCancellationSignals.get(f);
        if (signals != null) {
    ...
    /* access modifiers changed from: package-private */
    public void setExitAnimationOrder(C0198Fragment f, boolean isPop) {
    ...
    private void destroyFragmentView(C0198Fragment fragment) {
    ...
    /* access modifiers changed from: package-private */
    public void moveToState(C0198Fragment f) {
        moveToState(f, this.mCurState);
    }

    private void completeShowHideFragment(final C0198Fragment fragment) {
     ...
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public void moveFragmentToExpectedState(androidx.fragment.app.C0198Fragment r7) {
        /*
            r6 = this;
    ...
    public void moveToState(int newState, boolean always) {
        ...
        if (this.mHost == null && newState != -1) {
            ...
            for (C0198Fragment f : this.mFragmentStore.getFragments()) {
                moveFragmentToExpectedState(f);
            }
            for (C0198Fragment f2 : this.mFragmentStore.getActiveFragments()) {
    ...
    private void startPendingDeferredFragments() {
        for (C0198Fragment f : this.mFragmentStore.getActiveFragments()) {
            if (f != null) {
    ...
    /* access modifiers changed from: package-private */
    public void makeActive(C0198Fragment f) {
    ...
    /* access modifiers changed from: package-private */
    public void hideFragment(C0198Fragment fragment) {
        if (isLoggingEnabled(2)) {
    ...
    /* access modifiers changed from: package-private */
    public void showFragment(C0198Fragment fragment) {
        if (isLoggingEnabled(2)) {
    ...
    /* access modifiers changed from: package-private */
    public void detachFragment(C0198Fragment fragment) {
        if (isLoggingEnabled(2)) {
    ...
    /* access modifiers changed from: package-private */
    public void attachFragment(C0198Fragment fragment) {
        if (isLoggingEnabled(2)) {
    ...
    private void executeOpsTogether(ArrayList<BackStackRecord> records, ArrayList<Boolean> isRecordPop, int startIndex, int endIndex) {
        ...
        ArrayList<C0198Fragment> arrayList3 = this.mTmpAddedFragments;
        if (arrayList3 == null) {
        ...
        C0198Fragment oldPrimaryNav = getPrimaryNavigationFragment();
        while (true) {
            boolean z = true;
            if (recordNum >= i2) {
                break;
        ...
        if (allowReordering) {
            ArraySet<C0198Fragment> addedFragments = new ArraySet<>();
    ...
    private void makeRemovedFragmentsInvisible(ArraySet<C0198Fragment> fragments) {
        int numAdded = fragments.size();
        for (int i = 0; i < numAdded; i++) {
            C0198Fragment fragment = fragments.valueAt(i);
            if (!fragment.mAdded) {
    ...
    private int postponePostponableTransactions(ArrayList<BackStackRecord> records, ArrayList<Boolean> isRecordPop, int startIndex, int endIndex, ArraySet<C0198Fragment> added) {
        int postponeIndex = endIndex;
    ...
    public void completeExecute(BackStackRecord record, boolean isPop, boolean runTransitions, boolean moveToState) {
        ...
        for (C0198Fragment fragment : this.mFragmentStore.getActiveFragments()) {
    ...
    private void setVisibleRemovingFragment(C0198Fragment f) {
        ViewGroup container = getFragmentContainer(f);
        if (container != null) {
            if (container.getTag(C1024R.C1027id.visible_removing_fragment_view_tag) == null) {
                container.setTag(C1024R.C1027id.visible_removing_fragment_view_tag, f);
            }
            ((C0198Fragment) container.getTag(C1024R.C1027id.visible_removing_fragment_view_tag)).setNextAnim(f.getNextAnim());
        }
    }

    private ViewGroup getFragmentContainer(C0198Fragment f) {
    ...
    private void addAddedFragments(ArraySet<C0198Fragment> added) {
        int i = this.mCurState;
        if (i >= 1) {
            int state = Math.min(i, 3);
            for (C0198Fragment fragment : this.mFragmentStore.getFragments()) {
    ...
    private void endAnimatingAwayFragments() {
        if (!this.mExitAnimationCancellationSignals.isEmpty()) {
            for (C0198Fragment fragment : this.mExitAnimationCancellationSignals.keySet()) {
        ...
        if (state != null) {
            ...
            if (fms.mActive != null) {
                ...
                while (it.hasNext()) {
                    ...
                    if (fs != null) {
                        C0198Fragment retainedFragment = this.mNonConfig.findRetainedFragmentByWho(fs.mWho);
                ...
                for (C0198Fragment f2 : this.mNonConfig.getRetainedFragments()) {
                ...
                if (fms.mPrimaryNavActiveWho != null) {
                    C0198Fragment findActiveFragment = findActiveFragment(fms.mPrimaryNavActiveWho);
    ...
    /* access modifiers changed from: package-private */
    public C0198Fragment getParent() {
        return this.mParent;
    }
    ...
    /* JADX WARNING: Multi-variable type inference failed */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public void attachController(androidx.fragment.app.FragmentHostCallback<?> r5, androidx.fragment.app.FragmentContainer r6, androidx.fragment.app.C0198Fragment r7) {
        /*
            r4 = this;
    ...
    public boolean dispatchCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        ...
        boolean show = false;
        ArrayList<C0198Fragment> newMenus = null;
        for (C0198Fragment f : this.mFragmentStore.getFragments()) {
        ...
        if (this.mCreatedMenus != null) {
            for (int i = 0; i < this.mCreatedMenus.size(); i++) {
                C0198Fragment f2 = this.mCreatedMenus.get(i);
    ...
    /* access modifiers changed from: package-private */
    public void setPrimaryNavigationFragment(C0198Fragment f) {
        if (f == null || (f.equals(findActiveFragment(f.mWho)) && (f.mHost == null || f.mFragmentManager == this))) {
            C0198Fragment previousPrimaryNav = this.mPrimaryNav;
            this.mPrimaryNav = f;
    ...
    private void dispatchParentPrimaryNavigationFragmentChanged(C0198Fragment f) {
    ...
    public C0198Fragment getPrimaryNavigationFragment() {
        return this.mPrimaryNav;
    }

    /* access modifiers changed from: package-private */
    public void setMaxLifecycle(C0198Fragment f, Lifecycle.State state) {
    ...
    private boolean isMenuAvailable(C0198Fragment f) {
    ...
    static class StartEnterTransitionListener implements C0198Fragment.OnStartEnterTransitionListener {
        ...
        public void completeTransaction() {
            ...
            for (C0198Fragment fragment : this.mRecord.mManager.getFragments()) {
                fragment.setOnStartEnterTransitionListener((C0198Fragment.OnStartEnterTransitionListener) null);
