...
public class C0198Fragment implements ComponentCallbacks, View.OnCreateContextMenuListener, LifecycleOwner, ViewModelStoreOwner, HasDefaultViewModelProviderFactory, SavedStateRegistryOwner {
    ...
    /* renamed from: androidx.fragment.app.Fragment$OnStartEnterTransitionListener */
    ...
    /* renamed from: androidx.fragment.app.Fragment$InstantiationException */
    ...
    public C0198Fragment() {
        ...
        this.mPostponedDurationRunnable = new Runnable() {
            public void run() {
                C0198Fragment.this.startPostponedEnterTransition();
            }
        };
    ...
    public C0198Fragment(int contentLayoutId) {
        this();
        ...
        if (Build.VERSION.SDK_INT >= 19) {
            this.mLifecycleRegistry.addObserver(new LifecycleEventObserver() {
                public void onStateChanged(LifecycleOwner source, Lifecycle.Event event) {
                    if (event == Lifecycle.Event.ON_STOP && C0198Fragment.this.mView != null) {
                        C0198Fragment.this.mView.cancelPendingInputEvents();
                    }
                }
            });
        }
    ...
    @Deprecated
    public static C0198Fragment instantiate(Context context, String fname) {
        return instantiate(context, fname, (Bundle) null);
    }

    @Deprecated
    public static C0198Fragment instantiate(Context context, String fname, Bundle args) {
        try {
            C0198Fragment f = (C0198Fragment) FragmentFactory.loadFragmentClass(context.getClassLoader(), fname).getConstructor(new Class[0]).newInstance(new Object[0]);
            if (args != null) {
    ...
    public final C0198Fragment getTargetFragment() {
        String str;
        C0198Fragment fragment = this.mTarget;
        if (fragment != null) {
            return fragment;
        }
        FragmentManager fragmentManager = this.mFragmentManager;
    ...
    public final C0198Fragment getParentFragment() {
        return this.mParentFragment;
    }

    public final C0198Fragment requireParentFragment() {
        C0198Fragment parentFragment = getParentFragment();
    ...
    public final boolean isRemovingParent() {
        C0198Fragment parent = getParentFragment();
    ...
    public final boolean isVisible() {
        ...
        L_0x0021:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.fragment.app.C0198Fragment.isVisible():boolean");
    }
    ...
    public void onAttachFragment(C0198Fragment childFragment) {
    }
    ...
    public void startPostponedEnterTransition() {
        ...
        if (fragmentManager == null || fragmentManager.mHost == null) {
            ...
            this.mFragmentManager.mHost.getHandler().postAtFrontOfQueue(new Runnable() {
                public void run() {
                    C0198Fragment.this.callStartTransitionListener();
                }
            });
        } else {
    ...
    public void dump(String prefix, FileDescriptor fd, PrintWriter writer, String[] args) {
        ...
        C0198Fragment target = getTargetFragment();
        if (target != null) {
            writer.print(prefix);
    ...
    public void performAttach() {
        this.mChildFragmentManager.attachController(this.mHost, new FragmentContainer() {
            public View onFindViewById(int id) {
                if (C0198Fragment.this.mView != null) {
                    return C0198Fragment.this.mView.findViewById(id);
                }
                throw new IllegalStateException("Fragment " + this + " does not have a view");
            }

            public boolean onHasView() {
                return C0198Fragment.this.mView != null;
            }
        }, this);
        this.mState = 0;
        this.mCalled = false;
    ...
    /* renamed from: androidx.fragment.app.Fragment$AnimationInfo */
    static class AnimationInfo {
        ...
        int mNextAnim;
        int mNextTransition;
        Object mReenterTransition = C0198Fragment.USE_DEFAULT_TRANSITION;
        Object mReturnTransition = C0198Fragment.USE_DEFAULT_TRANSITION;
        Object mSharedElementEnterTransition = null;
        Object mSharedElementReturnTransition = C0198Fragment.USE_DEFAULT_TRANSITION;
