...
class FragmentStateManager {
    ...
    private final C0198Fragment mFragment;
    private int mFragmentManagerState = -1;

    FragmentStateManager(FragmentLifecycleCallbacksDispatcher dispatcher, C0198Fragment fragment) {
    ...
    FragmentStateManager(FragmentLifecycleCallbacksDispatcher dispatcher, C0198Fragment retainedFragment, FragmentState fs) {
        this.mDispatcher = dispatcher;
        ...
        C0198Fragment fragment = this.mFragment;
    ...
    public C0198Fragment getFragment() {
    ...
    public int computeMaxState() {
        ...
        int i = C02161.$SwitchMap$androidx$lifecycle$Lifecycle$State[this.mFragment.mMaxState.ordinal()];
        if (i == 1) {
            return maxState;
        }
        if (i == 2) {
    ...
    public void ensureInflatedView() {
        if (this.mFragment.mFromLayout && this.mFragment.mInLayout && !this.mFragment.mPerformedCreateView) {
            ...
            if (this.mFragment.mView != null) {
                ...
                this.mFragment.mView.setTag(C1024R.C1027id.fragment_container_view_tag, this.mFragment);
                if (this.mFragment.mHidden) {
                    this.mFragment.mView.setVisibility(8);
                }
                C0198Fragment fragment2 = this.mFragment;
                fragment2.onViewCreated(fragment2.mView, this.mFragment.mSavedFragmentState);
                FragmentLifecycleCallbacksDispatcher fragmentLifecycleCallbacksDispatcher = this.mDispatcher;
                C0198Fragment fragment3 = this.mFragment;
    ...
    public void restoreState(ClassLoader classLoader) {
        if (this.mFragment.mSavedFragmentState != null) {
            ...
            if (this.mFragment.mSavedUserVisibleHint != null) {
                C0198Fragment fragment4 = this.mFragment;
                fragment4.mUserVisibleHint = fragment4.mSavedUserVisibleHint.booleanValue();
                this.mFragment.mSavedUserVisibleHint = null;
            } else {
                C0198Fragment fragment5 = this.mFragment;
    ...
    /* access modifiers changed from: package-private */
    public void attach(FragmentHostCallback<?> host, FragmentManager fragmentManager, C0198Fragment parentFragment) {
    ...
    public void createView(androidx.fragment.app.FragmentContainer r7) {
        ...
        L_0x00b7:
            ...
            androidx.fragment.app.Fragment r1 = r6.mFragment
            android.view.View r1 = r1.mView
            int r3 = androidx.fragment.C1024R.C1027id.fragment_container_view_tag
            androidx.fragment.app.Fragment r4 = r6.mFragment
            r1.setTag(r3, r4)
    ...
    /* access modifiers changed from: package-private */
    public C0198Fragment.SavedState saveInstanceState() {
        Bundle result;
        if (this.mFragment.mState <= -1 || (result = saveBasicState()) == null) {
            return null;
        }
        return new C0198Fragment.SavedState(result);
    }
