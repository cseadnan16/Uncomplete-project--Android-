...
public abstract class FragmentStateAdapter extends RecyclerView.C0354Adapter<FragmentViewHolder> implements StatefulAdapter {
    private static final long GRACE_WINDOW_TIME_MS = 10000;
    private static final String KEY_PREFIX_FRAGMENT = "f#";
    private static final String KEY_PREFIX_STATE = "s#";
    final FragmentManager mFragmentManager;
    private FragmentMaxLifecycleEnforcer mFragmentMaxLifecycleEnforcer;
    final LongSparseArray<C0198Fragment> mFragments;
    private boolean mHasStaleFragments;
    boolean mIsInGracePeriod;
    private final LongSparseArray<Integer> mItemIdToViewHolder;
    final Lifecycle mLifecycle;
    private final LongSparseArray<C0198Fragment.SavedState> mSavedStates;

    public abstract C0198Fragment createFragment(int i);

    public FragmentStateAdapter(FragmentActivity fragmentActivity) {
        this(fragmentActivity.getSupportFragmentManager(), fragmentActivity.getLifecycle());
    }

    public FragmentStateAdapter(C0198Fragment fragment) {
    ...
    private boolean isFragmentViewBound(long itemId) {
        ...
        C0198Fragment fragment = this.mFragments.get(itemId);
    ...
    private void ensureFragment(int position) {
        ...
        if (!this.mFragments.containsKey(itemId)) {
            C0198Fragment newFragment = createFragment(position);
    ...
    public void placeFragmentInViewHolder(final FragmentViewHolder holder) {
        C0198Fragment fragment = this.mFragments.get(holder.getItemId());
        if (fragment != null) {
    ...
    private void scheduleViewAttach(final C0198Fragment fragment, final FrameLayout container) {
    ...
    public final void restoreState(Parcelable savedState) {
        ...
        for (String key : bundle.keySet()) {
            if (isValidKey(key, KEY_PREFIX_FRAGMENT)) {
                ...
                C0198Fragment.SavedState state = (C0198Fragment.SavedState) bundle.getParcelable(key);
                if (containsItem(itemId)) {
    ...
    class FragmentMaxLifecycleEnforcer {
        ...
        public void register(RecyclerView recyclerView) {
            ...
            C04331 r0 = new ViewPager2.OnPageChangeCallback() {
            ...
            C04342 r02 = new DataSetChangeObserver() {
        ...
        public void updateFragmentMaxLifecycle(boolean dataSetChanged) {
            int currentItem;
            C0198Fragment currentItemFragment;
