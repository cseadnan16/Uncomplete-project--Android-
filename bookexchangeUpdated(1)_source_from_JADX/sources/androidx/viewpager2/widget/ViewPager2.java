...
import androidx.viewpager2.C1109R;
...
public final class ViewPager2 extends ViewGroup {
    ...
    private void setOrientation(Context context, AttributeSet attrs) {
        TypedArray a = context.obtainStyledAttributes(attrs, C1109R.styleable.ViewPager2);
        if (Build.VERSION.SDK_INT >= 29) {
            saveAttributeDataForStyleable(context, C1109R.styleable.ViewPager2, attrs, a, 0, 0);
        }
        try {
            setOrientation(a.getInt(C1109R.styleable.ViewPager2_android_orientation, 0));
        } finally {
            a.recycle();
        }
    }
    ...
    public Parcelable onSaveInstanceState() {
        ...
        if (parcelable != null) {
            ...
            RecyclerView.C0354Adapter<?> adapter = this.mRecyclerView.getAdapter();
    ...
    private void restorePendingState() {
        RecyclerView.C0354Adapter<?> adapter;
    ...
    public void setAdapter(RecyclerView.C0354Adapter adapter) {
        RecyclerView.C0354Adapter<?> currentAdapter = this.mRecyclerView.getAdapter();
    ...
    private void registerCurrentItemDataSetTracker(RecyclerView.C0354Adapter<?> adapter) {
        if (adapter != null) {
            adapter.registerAdapterDataObserver(this.mCurrentItemDataSetChangeObserver);
        }
    }

    private void unregisterCurrentItemDataSetTracker(RecyclerView.C0354Adapter<?> adapter) {
        if (adapter != null) {
            adapter.unregisterAdapterDataObserver(this.mCurrentItemDataSetChangeObserver);
        }
    }

    public RecyclerView.C0354Adapter getAdapter() {
    ...
    public void setCurrentItemInternal(int item, boolean smoothScroll) {
        RecyclerView.C0354Adapter<?> adapter = getAdapter();
        if (adapter == null) {
    ...
    private abstract class AccessibilityProvider {
        ...
        /* access modifiers changed from: package-private */
        public void onAttachAdapter(RecyclerView.C0354Adapter<?> adapter) {
        }

        /* access modifiers changed from: package-private */
        public void onDetachAdapter(RecyclerView.C0354Adapter<?> adapter) {
        }
    ...
    class PageAwareAccessibilityProvider extends AccessibilityProvider {
        ...
        public void onAttachAdapter(RecyclerView.C0354Adapter<?> newAdapter) {
            updatePageAccessibilityActions();
            if (newAdapter != null) {
        ...
        public void onDetachAdapter(RecyclerView.C0354Adapter<?> oldAdapter) {
            if (oldAdapter != null) {
        ...
        private void addScrollActions(AccessibilityNodeInfo info) {
            int itemCount;
            RecyclerView.C0354Adapter<?> adapter = ViewPager2.this.getAdapter();
