...
import androidx.recyclerview.C1079R;
...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2, NestedScrollingChild3 {
    ...
    public RecyclerView(Context context, AttributeSet attrs) {
        this(context, attrs, C1079R.attr.recyclerViewStyle);
    }
    ...
    public RecyclerView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = context2.obtainStyledAttributes(attributeSet, C1079R.styleable.RecyclerView, i, 0);
        if (Build.VERSION.SDK_INT >= 29) {
            saveAttributeDataForStyleable(context, C1079R.styleable.RecyclerView, attrs, a, defStyleAttr, 0);
        }
        String layoutManagerName = a.getString(C1079R.styleable.RecyclerView_layoutManager);
        int descendantFocusability = a.getInt(C1079R.styleable.RecyclerView_android_descendantFocusability, -1);
        if (descendantFocusability == -1) {
            setDescendantFocusability(262144);
        }
        this.mClipToPadding = a.getBoolean(C1079R.styleable.RecyclerView_android_clipToPadding, true);
        boolean z = a.getBoolean(C1079R.styleable.RecyclerView_fastScrollEnabled, false);
        this.mEnableFastScroller = z;
        if (z) {
            initFastScroller((StateListDrawable) a.getDrawable(C1079R.styleable.RecyclerView_fastScrollVerticalThumbDrawable), a.getDrawable(C1079R.styleable.RecyclerView_fastScrollVerticalTrackDrawable), (StateListDrawable) a.getDrawable(C1079R.styleable.RecyclerView_fastScrollHorizontalThumbDrawable), a.getDrawable(C1079R.styleable.RecyclerView_fastScrollHorizontalTrackDrawable));
        }
        a.recycle();
        createLayoutManager(context, layoutManagerName, attrs, defStyleAttr, 0);
        boolean nestedScrollingEnabled = true;
        if (Build.VERSION.SDK_INT >= 21) {
            TypedArray a2 = context2.obtainStyledAttributes(attributeSet, NESTED_SCROLLING_ATTRS, i, 0);
            if (Build.VERSION.SDK_INT >= 29) {
    ...
    public void swapAdapter(C0354Adapter adapter, boolean removeAndRecycleExistingViews) {
    ...
    public void setAdapter(C0354Adapter adapter) {
        setLayoutFrozen(false);
    ...
    private void setAdapterInternal(C0354Adapter adapter, boolean compatibleWithPrevious, boolean removeAndRecycleViews) {
        C0354Adapter adapter2 = this.mAdapter;
        if (adapter2 != null) {
        ...
        C0354Adapter oldAdapter = this.mAdapter;
    ...
    public C0354Adapter getAdapter() {
    ...
    public void onMeasure(int widthSpec, int heightSpec) {
        ...
        if (layoutManager.isAutoMeasureEnabled()) {
            ...
            C0354Adapter adapter = this.mAdapter;
            if (adapter != null) {
    ...
    public static class RecycledViewPool {
        ...
        /* access modifiers changed from: package-private */
        public void onAdapterChanged(C0354Adapter oldAdapter, C0354Adapter newAdapter, boolean compatibleWithPrevious) {
            if (oldAdapter != null) {
                detach();
            }
    ...
    /* renamed from: androidx.recyclerview.widget.RecyclerView$Adapter */
    public static abstract class C0354Adapter<VH extends ViewHolder> {
    ...
    public static abstract class LayoutManager {
        ...
        public int getItemCount() {
            RecyclerView recyclerView = this.mRecyclerView;
            C0354Adapter a = recyclerView != null ? recyclerView.getAdapter() : null;
            if (a != null) {
        ...
        public void onAdapterChanged(C0354Adapter oldAdapter, C0354Adapter newAdapter) {
        }
        ...
        public static Properties getProperties(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
            ...
            TypedArray a = context.obtainStyledAttributes(attrs, C1079R.styleable.RecyclerView, defStyleAttr, defStyleRes);
            properties.orientation = a.getInt(C1079R.styleable.RecyclerView_android_orientation, 1);
            properties.spanCount = a.getInt(C1079R.styleable.RecyclerView_spanCount, 1);
            properties.reverseLayout = a.getBoolean(C1079R.styleable.RecyclerView_reverseLayout, false);
            properties.stackFromEnd = a.getBoolean(C1079R.styleable.RecyclerView_stackFromEnd, false);
            a.recycle();
            return properties;
        }
    ...
    public void initFastScroller(StateListDrawable verticalThumbDrawable, Drawable verticalTrackDrawable, StateListDrawable horizontalThumbDrawable, Drawable horizontalTrackDrawable) {
        ...
        new FastScroller(this, verticalThumbDrawable, verticalTrackDrawable, horizontalThumbDrawable, horizontalTrackDrawable, resources.getDimensionPixelSize(C1079R.dimen.fastscroll_default_thickness), resources.getDimensionPixelSize(C1079R.dimen.fastscroll_minimum_range), resources.getDimensionPixelOffset(C1079R.dimen.fastscroll_margin));
    }
    ...
    public static class State {
        ...
        /* access modifiers changed from: package-private */
        public void prepareForNestedPrefetch(C0354Adapter adapter) {
            this.mLayoutStep = 1;
