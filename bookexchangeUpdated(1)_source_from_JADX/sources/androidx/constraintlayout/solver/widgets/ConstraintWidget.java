...
public class ConstraintWidget {
    ...
    public String toString() {
        ...
        sb.append(str2);
        sb.append("(");
        sb.append(this.f13mX);
        sb.append(", ");
        sb.append(this.f14mY);
        sb.append(") - (");
    ...
    public int getRootX() {
        return this.f13mX + this.mOffsetX;
    }

    /* access modifiers changed from: protected */
    public int getRootY() {
        return this.f14mY + this.mOffsetY;
    }
    ...
    public void setGoneMargin(ConstraintAnchor.Type type, int goneMargin) {
        int i = C01321.f15x4c44d048[type.ordinal()];
        if (i == 1) {
    ...
    public void updateDrawPosition() {
        int left = this.f13mX;
        int top = this.f14mY;
        int right = this.f13mX + this.mWidth;
        int bottom = this.f14mY + this.mHeight;
        this.mDrawX = left;
        this.mDrawY = top;
    ...
    public ConstraintAnchor getAnchor(ConstraintAnchor.Type anchorType) {
        switch (C01321.f15x4c44d048[anchorType.ordinal()]) {
            case 1:
                return this.mLeft;
            case 2:
                return this.mTop;
    ...
    /* JADX WARNING: Removed duplicated region for block: B:153:0x02e9  */
    /* JADX WARNING: Removed duplicated region for block: B:154:0x02f2  */
    ...
    /* JADX WARNING: Removed duplicated region for block: B:167:0x036a  */
    ...
    private void applyConstraints(LinearSystem system, boolean parentWrapContent, SolverVariable parentMin, SolverVariable parentMax, DimensionBehaviour dimensionBehaviour, boolean wrapContent, ConstraintAnchor beginAnchor, ConstraintAnchor endAnchor, int beginPosition, int dimension, int minDimension, int maxDimension, float bias, boolean useRatio, boolean inChain, int matchConstraintDefault, int matchMinDimension, int matchMaxDimension, float matchPercentDimension, boolean applyPosition) {
        ...
        int i7 = C01321.f16xdde91696[dimensionBehaviour.ordinal()];
    ...
    static /* synthetic */ class C01321 {
        ...
        static final /* synthetic */ int[] f16xdde91696;
        ...
        static {
            ...
            try {
                f16xdde91696[DimensionBehaviour.WRAP_CONTENT.ordinal()] = 2;
            } catch (NoSuchFieldError e2) {
            }
            try {
                f16xdde91696[DimensionBehaviour.MATCH_PARENT.ordinal()] = 3;
            } catch (NoSuchFieldError e3) {
            }
            try {
                f16xdde91696[DimensionBehaviour.MATCH_CONSTRAINT.ordinal()] = 4;
            ...
            try {
                f15x4c44d048[ConstraintAnchor.Type.TOP.ordinal()] = 2;
            } catch (NoSuchFieldError e6) {
            }
            try {
                f15x4c44d048[ConstraintAnchor.Type.RIGHT.ordinal()] = 3;
            } catch (NoSuchFieldError e7) {
            }
            try {
                f15x4c44d048[ConstraintAnchor.Type.BOTTOM.ordinal()] = 4;
            } catch (NoSuchFieldError e8) {
            }
            try {
                f15x4c44d048[ConstraintAnchor.Type.BASELINE.ordinal()] = 5;
            } catch (NoSuchFieldError e9) {
            }
            try {
                f15x4c44d048[ConstraintAnchor.Type.CENTER.ordinal()] = 6;
            } catch (NoSuchFieldError e10) {
            }
            try {
                f15x4c44d048[ConstraintAnchor.Type.CENTER_X.ordinal()] = 7;
            } catch (NoSuchFieldError e11) {
            }
            try {
                f15x4c44d048[ConstraintAnchor.Type.CENTER_Y.ordinal()] = 8;
            } catch (NoSuchFieldError e12) {
            }
            try {
                f15x4c44d048[ConstraintAnchor.Type.NONE.ordinal()] = 9;
