...
public class LinearSystem {
    ...
    public SolverVariable createObjectVariable(Object anchor) {
        ...
        if (anchor instanceof ConstraintAnchor) {
            ...
            if (variable.f11id == -1 || variable.f11id > this.mVariablesID || this.mCache.mIndexedVariables[variable.f11id] == null) {
                if (variable.f11id != -1) {
                    variable.reset();
                }
    ...
    private final int optimize(Row goal, boolean b) {
        ...
        while (!done) {
            ...
            if (goal.getKey() != null) {
                this.mAlreadyTestedCandidates[goal.getKey().f11id] = true;
            }
