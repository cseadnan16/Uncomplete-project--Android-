...
public class NavDestination {
    ...
    public void onInflate(Context context, AttributeSet attrs) {
        TypedArray a = context.getResources().obtainAttributes(attrs, C1065R.styleable.Navigator);
        setId(a.getResourceId(C1065R.styleable.Navigator_android_id, 0));
        this.mIdName = getDisplayName(context, this.mId);
        setLabel(a.getText(C1065R.styleable.Navigator_android_label));
        a.recycle();
    }
