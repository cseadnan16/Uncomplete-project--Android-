...
public class ActivityNavigator extends Navigator<Destination> {
    ...
    public static class Destination extends NavDestination {
        ...
        public void onInflate(Context context, AttributeSet attrs) {
            ...
            TypedArray a = context.getResources().obtainAttributes(attrs, C1061R.styleable.ActivityNavigator);
            String targetPackage = a.getString(C1061R.styleable.ActivityNavigator_targetPackage);
            if (targetPackage != null) {
                targetPackage = targetPackage.replace("${applicationId}", context.getPackageName());
            }
            setTargetPackage(targetPackage);
            String className = a.getString(C1061R.styleable.ActivityNavigator_android_name);
            if (className != null) {
            ...
            setAction(a.getString(C1061R.styleable.ActivityNavigator_action));
            String data = a.getString(C1061R.styleable.ActivityNavigator_data);
            if (data != null) {
                setData(Uri.parse(data));
            }
            setDataPattern(a.getString(C1061R.styleable.ActivityNavigator_dataPattern));
            a.recycle();
        }
