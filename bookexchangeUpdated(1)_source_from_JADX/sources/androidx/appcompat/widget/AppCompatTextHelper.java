...
import androidx.appcompat.C0987R;
...
class AppCompatTextHelper {
    ...
    public void loadFromAttributes(AttributeSet attrs, int defStyleAttr) {
        ...
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(context, attributeSet, C0987R.styleable.AppCompatTextHelper, i, 0);
        int ap = a.getResourceId(C0987R.styleable.AppCompatTextHelper_android_textAppearance, -1);
        if (a.hasValue(C0987R.styleable.AppCompatTextHelper_android_drawableLeft)) {
            this.mDrawableLeftTint = createTintInfo(context, drawableManager, a.getResourceId(C0987R.styleable.AppCompatTextHelper_android_drawableLeft, 0));
        }
        if (a.hasValue(C0987R.styleable.AppCompatTextHelper_android_drawableTop)) {
            this.mDrawableTopTint = createTintInfo(context, drawableManager, a.getResourceId(C0987R.styleable.AppCompatTextHelper_android_drawableTop, 0));
        }
        if (a.hasValue(C0987R.styleable.AppCompatTextHelper_android_drawableRight)) {
            this.mDrawableRightTint = createTintInfo(context, drawableManager, a.getResourceId(C0987R.styleable.AppCompatTextHelper_android_drawableRight, 0));
        }
        if (a.hasValue(C0987R.styleable.AppCompatTextHelper_android_drawableBottom)) {
            this.mDrawableBottomTint = createTintInfo(context, drawableManager, a.getResourceId(C0987R.styleable.AppCompatTextHelper_android_drawableBottom, 0));
        }
        if (Build.VERSION.SDK_INT >= 17) {
            if (a.hasValue(C0987R.styleable.AppCompatTextHelper_android_drawableStart)) {
                this.mDrawableStartTint = createTintInfo(context, drawableManager, a.getResourceId(C0987R.styleable.AppCompatTextHelper_android_drawableStart, 0));
            }
            if (a.hasValue(C0987R.styleable.AppCompatTextHelper_android_drawableEnd)) {
                this.mDrawableEndTint = createTintInfo(context, drawableManager, a.getResourceId(C0987R.styleable.AppCompatTextHelper_android_drawableEnd, 0));
            }
        }
        a.recycle();
        ...
        if (ap != -1) {
            TintTypedArray a2 = TintTypedArray.obtainStyledAttributes(context, ap, C0987R.styleable.TextAppearance);
            if (!hasPwdTm && a2.hasValue(C0987R.styleable.TextAppearance_textAllCaps)) {
                allCapsSet2 = true;
                allCaps2 = a2.getBoolean(C0987R.styleable.TextAppearance_textAllCaps, false);
            }
            updateTypefaceAndStyle(context, a2);
            if (Build.VERSION.SDK_INT < 23) {
                if (a2.hasValue(C0987R.styleable.TextAppearance_android_textColor)) {
                    textColor2 = a2.getColorStateList(C0987R.styleable.TextAppearance_android_textColor);
                }
                if (a2.hasValue(C0987R.styleable.TextAppearance_android_textColorHint)) {
                    textColorHint = a2.getColorStateList(C0987R.styleable.TextAppearance_android_textColorHint);
                }
                if (a2.hasValue(C0987R.styleable.TextAppearance_android_textColorLink)) {
                    textColorLink2 = a2.getColorStateList(C0987R.styleable.TextAppearance_android_textColorLink);
                }
            }
            if (a2.hasValue(C0987R.styleable.TextAppearance_textLocale)) {
                localeListString2 = a2.getString(C0987R.styleable.TextAppearance_textLocale);
            }
            if (Build.VERSION.SDK_INT >= 26 && a2.hasValue(C0987R.styleable.TextAppearance_fontVariationSettings)) {
                fontVariation = a2.getString(C0987R.styleable.TextAppearance_fontVariationSettings);
            }
            a2.recycle();
        }
        TintTypedArray a3 = TintTypedArray.obtainStyledAttributes(context, attributeSet, C0987R.styleable.TextAppearance, i, 0);
        if (hasPwdTm || !a3.hasValue(C0987R.styleable.TextAppearance_textAllCaps)) {
            allCaps = allCaps2;
            allCapsSet = allCapsSet2;
        } else {
            allCaps = a3.getBoolean(C0987R.styleable.TextAppearance_textAllCaps, false);
            allCapsSet = true;
        }
        if (Build.VERSION.SDK_INT < 23) {
            if (a3.hasValue(C0987R.styleable.TextAppearance_android_textColor)) {
                textColor2 = a3.getColorStateList(C0987R.styleable.TextAppearance_android_textColor);
            }
            if (a3.hasValue(C0987R.styleable.TextAppearance_android_textColorHint)) {
                textColorHint = a3.getColorStateList(C0987R.styleable.TextAppearance_android_textColorHint);
            }
            if (a3.hasValue(C0987R.styleable.TextAppearance_android_textColorLink)) {
                textColorLink = textColor2;
                textColor = a3.getColorStateList(C0987R.styleable.TextAppearance_android_textColorLink);
            } else {
        ...
        if (a3.hasValue(C0987R.styleable.TextAppearance_textLocale)) {
            localeListString = a3.getString(C0987R.styleable.TextAppearance_textLocale);
        } else {
            localeListString = localeListString2;
        }
        if (Build.VERSION.SDK_INT >= 26 && a3.hasValue(C0987R.styleable.TextAppearance_fontVariationSettings)) {
            fontVariation = a3.getString(C0987R.styleable.TextAppearance_fontVariationSettings);
        }
        if (Build.VERSION.SDK_INT < 28) {
        } else if (!a3.hasValue(C0987R.styleable.TextAppearance_android_textSize)) {
        } else if (a3.getDimensionPixelSize(C0987R.styleable.TextAppearance_android_textSize, -1) == 0) {
            int i2 = ap;
        ...
        TintTypedArray a4 = TintTypedArray.obtainStyledAttributes(context, attributeSet, C0987R.styleable.AppCompatTextView);
        Drawable drawableEnd = null;
        Drawable drawableLeft = null;
        Drawable drawableTop = null;
        int drawableLeftId = a4.getResourceId(C0987R.styleable.AppCompatTextView_drawableLeftCompat, -1);
        if (drawableLeftId != -1) {
            drawableLeft = drawableManager.getDrawable(context, drawableLeftId);
        }
        int i3 = drawableLeftId;
        int drawableTopId = a4.getResourceId(C0987R.styleable.AppCompatTextView_drawableTopCompat, -1);
        if (drawableTopId != -1) {
            drawableTop = drawableManager.getDrawable(context, drawableTopId);
        }
        int i4 = drawableTopId;
        int drawableRightId = a4.getResourceId(C0987R.styleable.AppCompatTextView_drawableRightCompat, -1);
        if (drawableRightId != -1) {
            drawableRight = drawableManager.getDrawable(context, drawableRightId);
        } else {
            drawableRight = null;
        }
        int drawableBottomId = a4.getResourceId(C0987R.styleable.AppCompatTextView_drawableBottomCompat, -1);
        if (drawableBottomId != -1) {
            drawableBottom = drawableManager.getDrawable(context, drawableBottomId);
        } else {
            drawableBottom = null;
        }
        int drawableStartId = a4.getResourceId(C0987R.styleable.AppCompatTextView_drawableStartCompat, -1);
        if (drawableStartId != -1) {
            drawableStart = drawableManager.getDrawable(context, drawableStartId);
        } else {
            drawableStart = null;
        }
        int drawableEndId = a4.getResourceId(C0987R.styleable.AppCompatTextView_drawableEndCompat, -1);
        if (drawableEndId != -1) {
        ...
        if (a4.hasValue(C0987R.styleable.AppCompatTextView_drawableTint)) {
            TextViewCompat.setCompoundDrawableTintList(this.mView, a4.getColorStateList(C0987R.styleable.AppCompatTextView_drawableTint));
        }
        if (a4.hasValue(C0987R.styleable.AppCompatTextView_drawableTintMode)) {
            TextViewCompat.setCompoundDrawableTintMode(this.mView, DrawableUtils.parseTintMode(a4.getInt(C0987R.styleable.AppCompatTextView_drawableTintMode, -1), (PorterDuff.Mode) null));
        }
        int firstBaselineToTopHeight = a4.getDimensionPixelSize(C0987R.styleable.AppCompatTextView_firstBaselineToTopHeight, -1);
        int lastBaselineToBottomHeight = a4.getDimensionPixelSize(C0987R.styleable.AppCompatTextView_lastBaselineToBottomHeight, -1);
        int lineHeight = a4.getDimensionPixelSize(C0987R.styleable.AppCompatTextView_lineHeight, -1);
        a4.recycle();
    ...
    private void updateTypefaceAndStyle(Context context, TintTypedArray a) {
        ...
        this.mStyle = a.getInt(C0987R.styleable.TextAppearance_android_textStyle, this.mStyle);
        boolean z = false;
        if (Build.VERSION.SDK_INT >= 28) {
            int i = a.getInt(C0987R.styleable.TextAppearance_android_textFontWeight, -1);
            this.mFontWeight = i;
            if (i != -1) {
                this.mStyle = (this.mStyle & 2) | 0;
            }
        }
        if (a.hasValue(C0987R.styleable.TextAppearance_android_fontFamily) || a.hasValue(C0987R.styleable.TextAppearance_fontFamily)) {
            this.mFontTypeface = null;
            int fontFamilyId = a.hasValue(C0987R.styleable.TextAppearance_fontFamily) ? C0987R.styleable.TextAppearance_fontFamily : C0987R.styleable.TextAppearance_android_fontFamily;
        ...
        } else if (a.hasValue(C0987R.styleable.TextAppearance_android_typeface)) {
            this.mAsyncFontPending = false;
            int typefaceIndex = a.getInt(C0987R.styleable.TextAppearance_android_typeface, 1);
            if (typefaceIndex == 1) {
    ...
    public void onSetTextAppearance(Context context, int resId) {
        ...
        ColorStateList textColor;
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(context, resId, C0987R.styleable.TextAppearance);
        if (a.hasValue(C0987R.styleable.TextAppearance_textAllCaps)) {
            setAllCaps(a.getBoolean(C0987R.styleable.TextAppearance_textAllCaps, false));
        }
        if (Build.VERSION.SDK_INT < 23 && a.hasValue(C0987R.styleable.TextAppearance_android_textColor) && (textColor = a.getColorStateList(C0987R.styleable.TextAppearance_android_textColor)) != null) {
            this.mView.setTextColor(textColor);
        }
        if (a.hasValue(C0987R.styleable.TextAppearance_android_textSize) && a.getDimensionPixelSize(C0987R.styleable.TextAppearance_android_textSize, -1) == 0) {
            this.mView.setTextSize(0, 0.0f);
        }
        updateTypefaceAndStyle(context, a);
        if (Build.VERSION.SDK_INT >= 26 && a.hasValue(C0987R.styleable.TextAppearance_fontVariationSettings) && (fontVariation = a.getString(C0987R.styleable.TextAppearance_fontVariationSettings)) != null) {
            this.mView.setFontVariationSettings(fontVariation);
        }
        a.recycle();
        Typeface typeface = this.mFontTypeface;
