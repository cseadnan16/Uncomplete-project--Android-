...
class ActivityChooserModel extends DataSetObservable {
    ...
    private void readHistoricalDataImpl() {
        /*
            ...
            r1 = 0
            android.content.Context r2 = r12.mContext     // Catch:{ FileNotFoundException -> 0x00d5 }
            java.lang.String r3 = r12.mHistoryFileName     // Catch:{ FileNotFoundException -> 0x00d5 }
            java.io.FileInputStream r2 = r2.openFileInput(r3)     // Catch:{ FileNotFoundException -> 0x00d5 }
            r1 = r2
            org.xmlpull.v1.XmlPullParser r2 = android.util.Xml.newPullParser()     // Catch:{ XmlPullParserException -> 0x00ac, IOException -> 0x008e }
            java.lang.String r3 = "UTF-8"
            r2.setInput(r1, r3)     // Catch:{ XmlPullParserException -> 0x00ac, IOException -> 0x008e }
            r3 = 0
        L_0x0017:
            r4 = 1
            ...
            int r4 = r2.next()     // Catch:{ XmlPullParserException -> 0x00ac, IOException -> 0x008e }
            r3 = r4
            goto L_0x0017
        L_0x0023:
            java.lang.String r5 = "historical-records"
            java.lang.String r6 = r2.getName()     // Catch:{ XmlPullParserException -> 0x00ac, IOException -> 0x008e }
            boolean r5 = r5.equals(r6)     // Catch:{ XmlPullParserException -> 0x00ac, IOException -> 0x008e }
            if (r5 == 0) goto L_0x0084
            java.util.List<androidx.appcompat.widget.ActivityChooserModel$HistoricalRecord> r5 = r12.mHistoricalRecords     // Catch:{ XmlPullParserException -> 0x00ac, IOException -> 0x008e }
            r5.clear()     // Catch:{ XmlPullParserException -> 0x00ac, IOException -> 0x008e }
        L_0x0034:
            int r6 = r2.next()     // Catch:{ XmlPullParserException -> 0x00ac, IOException -> 0x008e }
            r3 = r6
        ...
        L_0x004a:
            ...
            boolean r7 = r7.equals(r6)     // Catch:{ XmlPullParserException -> 0x00ac, IOException -> 0x008e }
            if (r7 == 0) goto L_0x007c
            java.lang.String r7 = "activity"
            r8 = 0
            java.lang.String r7 = r2.getAttributeValue(r8, r7)     // Catch:{ XmlPullParserException -> 0x00ac, IOException -> 0x008e }
            java.lang.String r9 = "time"
            java.lang.String r9 = r2.getAttributeValue(r8, r9)     // Catch:{ XmlPullParserException -> 0x00ac, IOException -> 0x008e }
            long r9 = java.lang.Long.parseLong(r9)     // Catch:{ XmlPullParserException -> 0x00ac, IOException -> 0x008e }
            java.lang.String r11 = "weight"
            java.lang.String r8 = r2.getAttributeValue(r8, r11)     // Catch:{ XmlPullParserException -> 0x00ac, IOException -> 0x008e }
            float r8 = java.lang.Float.parseFloat(r8)     // Catch:{ XmlPullParserException -> 0x00ac, IOException -> 0x008e }
            androidx.appcompat.widget.ActivityChooserModel$HistoricalRecord r11 = new androidx.appcompat.widget.ActivityChooserModel$HistoricalRecord     // Catch:{ XmlPullParserException -> 0x00ac, IOException -> 0x008e }
            r11.<init>((java.lang.String) r7, (long) r9, (float) r8)     // Catch:{ XmlPullParserException -> 0x00ac, IOException -> 0x008e }
            r5.add(r11)     // Catch:{ XmlPullParserException -> 0x00ac, IOException -> 0x008e }
            goto L_0x0034
        L_0x007c:
            org.xmlpull.v1.XmlPullParserException r4 = new org.xmlpull.v1.XmlPullParserException     // Catch:{ XmlPullParserException -> 0x00ac, IOException -> 0x008e }
            java.lang.String r7 = "Share records file not well-formed."
            r4.<init>(r7)     // Catch:{ XmlPullParserException -> 0x00ac, IOException -> 0x008e }
            throw r4     // Catch:{ XmlPullParserException -> 0x00ac, IOException -> 0x008e }
        L_0x0084:
            org.xmlpull.v1.XmlPullParserException r4 = new org.xmlpull.v1.XmlPullParserException     // Catch:{ XmlPullParserException -> 0x00ac, IOException -> 0x008e }
            java.lang.String r5 = "Share records file does not start with historical-records tag."
            r4.<init>(r5)     // Catch:{ XmlPullParserException -> 0x00ac, IOException -> 0x008e }
            throw r4     // Catch:{ XmlPullParserException -> 0x00ac, IOException -> 0x008e }
        L_0x008c:
            r0 = move-exception
            goto L_0x00cd
        L_0x008e:
            ...
            java.lang.String r0 = r12.mHistoryFileName     // Catch:{ all -> 0x008c }
            r4.append(r0)     // Catch:{ all -> 0x008c }
            java.lang.String r0 = r4.toString()     // Catch:{ all -> 0x008c }
            android.util.Log.e(r3, r0, r2)     // Catch:{ all -> 0x008c }
            if (r1 == 0) goto L_0x00cc
            r1.close()     // Catch:{ IOException -> 0x00ca }
            goto L_0x00c9
        L_0x00ac:
    ...
    private final class PersistHistoryAsyncTask extends AsyncTask<Object, Void, Void> {
        ...
        /* JADX WARNING: Removed duplicated region for block: B:43:0x00fc A[SYNTHETIC, Splitter:B:43:0x00fc] */
        /* JADX WARNING: Removed duplicated region for block: B:51:0x010b A[SYNTHETIC, Splitter:B:51:0x010b] */
        /* JADX WARNING: Unknown top exception splitter block from list: {B:23:0x0091=Splitter:B:23:0x0091, B:31:0x00b7=Splitter:B:31:0x00b7, B:39:0x00dd=Splitter:B:39:0x00dd} */
        /* Code decompiled incorrectly, please refer to instructions dump. */
        public java.lang.Void doInBackground(java.lang.Object... r18) {
            /*
                ...
                r8 = 0
                r9 = 0
                androidx.appcompat.widget.ActivityChooserModel r10 = androidx.appcompat.widget.ActivityChooserModel.this     // Catch:{ FileNotFoundException -> 0x0111 }
                android.content.Context r10 = r10.mContext     // Catch:{ FileNotFoundException -> 0x0111 }
                java.io.FileOutputStream r10 = r10.openFileOutput(r7, r4)     // Catch:{ FileNotFoundException -> 0x0111 }
                r8 = r10
                org.xmlpull.v1.XmlSerializer r10 = android.util.Xml.newSerializer()
                r10.setOutput(r8, r9)     // Catch:{ IllegalArgumentException -> 0x00da, IllegalStateException -> 0x00b4, IOException -> 0x008e, all -> 0x0088 }
                java.lang.String r11 = "UTF-8"
                java.lang.Boolean r12 = java.lang.Boolean.valueOf(r6)     // Catch:{ IllegalArgumentException -> 0x00da, IllegalStateException -> 0x00b4, IOException -> 0x008e, all -> 0x0088 }
                r10.startDocument(r11, r12)     // Catch:{ IllegalArgumentException -> 0x00da, IllegalStateException -> 0x00b4, IOException -> 0x008e, all -> 0x0088 }
                r10.startTag(r9, r2)     // Catch:{ IllegalArgumentException -> 0x00da, IllegalStateException -> 0x00b4, IOException -> 0x008e, all -> 0x0088 }
                int r11 = r5.size()     // Catch:{ IllegalArgumentException -> 0x00da, IllegalStateException -> 0x00b4, IOException -> 0x008e, all -> 0x0088 }
                r12 = 0
            L_0x0036:
                if (r12 >= r11) goto L_0x006f
                java.lang.Object r13 = r5.remove(r4)     // Catch:{ IllegalArgumentException -> 0x00da, IllegalStateException -> 0x00b4, IOException -> 0x008e, all -> 0x0088 }
                androidx.appcompat.widget.ActivityChooserModel$HistoricalRecord r13 = (androidx.appcompat.widget.ActivityChooserModel.HistoricalRecord) r13     // Catch:{ IllegalArgumentException -> 0x00da, IllegalStateException -> 0x00b4, IOException -> 0x008e, all -> 0x0088 }
                r10.startTag(r9, r0)     // Catch:{ IllegalArgumentException -> 0x00da, IllegalStateException -> 0x00b4, IOException -> 0x008e, all -> 0x0088 }
                java.lang.String r14 = "activity"
                android.content.ComponentName r15 = r13.activity     // Catch:{ IllegalArgumentException -> 0x00da, IllegalStateException -> 0x00b4, IOException -> 0x008e, all -> 0x0088 }
                java.lang.String r15 = r15.flattenToString()     // Catch:{ IllegalArgumentException -> 0x00da, IllegalStateException -> 0x00b4, IOException -> 0x008e, all -> 0x0088 }
                r10.attribute(r9, r14, r15)     // Catch:{ IllegalArgumentException -> 0x00da, IllegalStateException -> 0x00b4, IOException -> 0x008e, all -> 0x0088 }
                ...
                r10.attribute(r9, r14, r4)     // Catch:{ IllegalArgumentException -> 0x0086, IllegalStateException -> 0x0084, IOException -> 0x0082 }
                ...
                r10.attribute(r9, r4, r5)     // Catch:{ IllegalArgumentException -> 0x0086, IllegalStateException -> 0x0084, IOException -> 0x0082 }
                r10.endTag(r9, r0)     // Catch:{ IllegalArgumentException -> 0x0086, IllegalStateException -> 0x0084, IOException -> 0x0082 }
                int r12 = r12 + 1
                r5 = r16
                r4 = 0
                goto L_0x0036
            L_0x006f:
                r16 = r5
                r10.endTag(r9, r2)     // Catch:{ IllegalArgumentException -> 0x0086, IllegalStateException -> 0x0084, IOException -> 0x0082 }
                r10.endDocument()     // Catch:{ IllegalArgumentException -> 0x0086, IllegalStateException -> 0x0084, IOException -> 0x0082 }
            ...
            L_0x008e:
                ...
                r16 = r5
            L_0x0091:
                java.lang.String r2 = androidx.appcompat.widget.ActivityChooserModel.LOG_TAG     // Catch:{ all -> 0x0103 }
                ...
                androidx.appcompat.widget.ActivityChooserModel r3 = androidx.appcompat.widget.ActivityChooserModel.this     // Catch:{ all -> 0x0103 }
                java.lang.String r3 = r3.mHistoryFileName     // Catch:{ all -> 0x0103 }
                r4.append(r3)     // Catch:{ all -> 0x0103 }
                java.lang.String r3 = r4.toString()     // Catch:{ all -> 0x0103 }
