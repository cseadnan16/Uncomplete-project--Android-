    ...
    private boolean tryOnMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        for (int i3 = 0; i3 < count; i3++) {
            ...
            if (child.getVisibility() != 8) {
                int id = child.getId();
                if (id == C0987R.C0990id.topPanel) {
                    topPanel = child;
                } else if (id == C0987R.C0990id.buttonPanel) {
                    buttonPanel = child;
                } else if ((id != C0987R.C0990id.contentPanel && id != C0987R.C0990id.customPanel) || middlePanel != null) {
                    return false;
                } else {
                    middlePanel = child;
                }
