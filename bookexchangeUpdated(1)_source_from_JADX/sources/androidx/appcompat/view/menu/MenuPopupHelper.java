...
public class MenuPopupHelper implements MenuHelper {
    ...
    public MenuPopupHelper(Context context, MenuBuilder menu) {
        this(context, menu, (View) null, false, C0987R.attr.popupMenuStyle, 0);
    }

    public MenuPopupHelper(Context context, MenuBuilder menu, View anchorView) {
        this(context, menu, anchorView, false, C0987R.attr.popupMenuStyle, 0);
    }
    ...
    private androidx.appcompat.view.menu.MenuPopup createPopup() {
        ...
        L_0x0021:
            ...
            int r5 = androidx.appcompat.C0987R.dimen.abc_cascading_menus_min_smallest_width
