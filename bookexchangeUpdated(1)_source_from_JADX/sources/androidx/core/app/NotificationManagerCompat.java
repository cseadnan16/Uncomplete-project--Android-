...
public final class NotificationManagerCompat {
    ...
    private static class NotifyTask implements Task {
        ...
        public void send(INotificationSideChannel service) throws RemoteException {
            service.notify(this.packageName, this.f23id, this.tag, this.notif);
        }

        public String toString() {
            return "NotifyTask[" + "packageName:" + this.packageName + ", id:" + this.f23id + ", tag:" + this.tag + "]";
        }
    }
    ...
    private static class CancelTask implements Task {
        ...
        public void send(INotificationSideChannel service) throws RemoteException {
            if (this.all) {
                ...
                service.cancel(this.packageName, this.f22id, this.tag);
            }
        }

        public String toString() {
            return "CancelTask[" + "packageName:" + this.packageName + ", id:" + this.f22id + ", tag:" + this.tag + ", all:" + this.all + "]";
        }
    }
}
