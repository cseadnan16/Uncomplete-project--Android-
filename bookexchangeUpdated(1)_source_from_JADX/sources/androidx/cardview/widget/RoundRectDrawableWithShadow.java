...
class RoundRectDrawableWithShadow extends Drawable {
    ...
    RoundRectDrawableWithShadow(Resources resources, ColorStateList backgroundColor, float radius, float shadowSize, float maxShadowSize) {
        this.mShadowStartColor = resources.getColor(C1001R.C1002color.cardview_shadow_start_color);
        this.mShadowEndColor = resources.getColor(C1001R.C1002color.cardview_shadow_end_color);
        this.mInsetShadow = resources.getDimensionPixelSize(C1001R.dimen.cardview_compat_inset_shadow);
