...
public class AdViewActivity extends AppCompatActivity {
    ...
    TextView id,apartment_no,rent_date,tenant;
    ...
    String Address,ApartmentNo,RentDate,Tenant,Description,SpaceSize,Renters,Utility,Category,Floor,Bedroom,Bathroom,Balconi,Kitchen,DiningRoom,DrawingRoom,Garage,ClosingTime,OpeningTime,NearestFamousPlaceOne,NearestFamousPlaceTwo,FeaturedImage;
    int Id;
